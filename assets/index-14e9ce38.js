...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Vp(i,e,t){const n=new Float32Array(ui),r=new U(0,1,0);return new Tn({name:"SphericalGaussianBlur",defines:{n:ui,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ts(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function $l(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ts(),fragmentShader:`
		...
		`,blending:Un,depthTest:!1,depthWrite:!1})}function Zl(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ts(),fragmentShader:`
	...
	`}class Qc extends Mn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Xc(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new bi(5,5,5),s=new Tn({name:"CubemapFromEquirect",uniforms:ji(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ht,blending:Un});s.uniforms.tEquirect.value=t;const a=new Qe(r,s),o=t.minFilter;return t.minFilter===di&&(t.minFilter=It),new Yf(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function Hp(i){let e=new WeakMap,t=new WeakMap,n=null;function r(u,g=!1){return u==null?null:g?a(u):s(u)}function s(u){if(u&&u.isTexture){const g=u.mapping;if(g===Ds||g===Ls)if(e.has(u)){const x=e.get(u).texture;return o(x,u.mapping)}else{const x=u.image;if(x&&x.height>0){const S=new Qc(x.height);return S.fromEquirectangularTexture(i,u),e.set(u,S),u.addEventListener("dispose",l),o(S.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const g=u.mapping,x=g===Ds||g===Ls,S=g===vi||g===Ji;if(x||S){let m=t.get(u);const d=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==d)return n===null&&(n=new Yl(i)),m=x?n.fromEquirectangular(u,m):n.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),m.texture;if(m!==void 0)return m.texture;{const y=u.image;return x&&y&&y.height>0||S&&y&&c(y)?(n===null&&(n=new Yl(i)),m=x?n.fromEquirectangular(u):n.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),u.addEventListener("dispose",f),m.texture):null}}}return u}function o(u,g){return g===Ds?u.mapping=vi:g===Ls&&(u.mapping=Ji),u}function c(u){let g=0;const x=6;for(let S=0;S<x;S++)u[S]!==void 0&&g++;return g===x}function l(u){const g=u.target;g.removeEventListener("dispose",l);const x=e.get(g);x!==void 0&&(e.delete(g),x.dispose())}function f(u){const g=u.target;g.removeEventListener("dispose",f);const x=t.get(g);x!==void 0&&(t.delete(g),x.dispose())}function h(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:h}}function kp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Yi("WebGLRenderer: "+n+" extension not supported."),r}}}function Wp(i,e,t,n){const r={},s=new WeakMap;function a(h){const u=h.target;u.index!==null&&e.remove(u.index);for(const x in u.attributes)e.remove(u.attributes[x]);u.removeEventListener("dispose",a),delete r[u.id];const g=s.get(u);g&&(e.remove(g),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(h,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function c(h){const u=h.attributes;for(const g in u)e.update(u[g],i.ARRAY_BUFFER)}function l(h){const u=[],g=h.index,x=h.attributes.position;let S=0;if(x===void 0)return;if(g!==null){const y=g.array;S=g.version;for(let w=0,M=y.length;w<M;w+=3){const A=y[w+0],b=y[w+1],R=y[w+2];u.push(A,b,b,R,R,A)}}else{const y=x.array;S=x.version;for(let w=0,M=y.length/3-1;w<M;w+=3){const A=w+0,b=w+1,R=w+2;u.push(A,b,b,R,R,A)}}const m=new(x.count>=65535?kc:Hc)(u,1);m.version=S;const d=s.get(h);d&&e.remove(d),s.set(h,m)}function f(h){const u=s.get(h);if(u){const g=h.index;g!==null&&u.version<g.version&&l(h)}else l(h);return s.get(h)}return{get:o,update:c,getWireframeAttribute:f}}function Xp(i,e,t){let n;function r(h){n=h}let s,a;function o(h){s=h.type,a=h.bytesPerElement}function c(h,u){i.drawElements(n,u,s,h*a),t.update(u,n,1)}function l(h,u,g){g!==0&&(i.drawElementsInstanced(n,u,s,h*a,g),t.update(u,n,g))}function f(h,u,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,u,0,s,h,0,g);let S=0;for(let m=0;m<g;m++)S+=u[m];t.update(S,n,1)}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=f}function qp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:Ve("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Yp(i,e,t){const n=new WeakMap,r=new lt;function s(a,o,c){const l=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=f!==void 0?f.length:0;let u=n.get(o);if(u===void 0||u.count!==h){let C=function(){_.dispose(),n.delete(o),o.removeEventListener("dispose",C)};var g=C;u!==void 0&&u.texture.dispose();const x=o.morphAttributes.position!==void 0,S=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],y=o.morphAttributes.normal||[],w=o.morphAttributes.color||[];let M=0;x===!0&&(M=1),S===!0&&(M=2),m===!0&&(M=3);let A=o.attributes.position.count*M,b=1;A>e.maxTextureSize&&(b=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const R=new Float32Array(A*b*4*h),_=new Gc(R,A,b,h);_.type=_n,_.needsUpdate=!0;const E=M*4;for(let P=0;P<h;P++){const N=d[P],X=y[P],$=w[P],O=A*b*4*P;for(let q=0;q<N.count;q++){const V=q*E;x===!0&&(r.fromBufferAttribute(N,q),R[O+V+0]=r.x,R[O+V+1]=r.y,R[O+V+2]=r.z,R[O+V+3]=0),S===!0&&(r.fromBufferAttribute(X,q),R[O+V+4]=r.x,R[O+V+5]=r.y,R[O+V+6]=r.z,R[O+V+7]=0),m===!0&&(r.fromBufferAttribute($,q),R[O+V+8]=r.x,R[O+V+9]=r.y,R[O+V+10]=r.z,R[O+V+11]=$.itemSize===4?r.w:1)}}u={count:h,texture:_,size:new Fe(A,b)},n.set(o,u),o.addEventListener("dispose",C)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let x=0;for(let m=0;m<l.length;m++)x+=l[m];const S=o.morphTargetsRelative?1:1-x;c.getUniforms().setValue(i,"morphTargetBaseInfluence",S),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:s}}function Kp(i,e,t,n,r){let s=new WeakMap;function a(l){const f=r.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==f&&(e.update(u),s.set(u,f)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==f&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,f))),l.isSkinnedMesh){const g=l.skeleton;s.get(g)!==f&&(g.update(),s.set(g,f))}return u}function o(){s=new WeakMap}function c(l){const f=l.target;f.removeEventListener("dispose",c),n.releaseStatesOfObject(f),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:a,dispose:o}}const $p={[bc]:"LINEAR_TONE_MAPPING",[Tc]:"REINHARD_TONE_MAPPING",[Ac]:"CINEON_TONE_MAPPING",[wc]:"ACES_FILMIC_TONE_MAPPING",[Cc]:"AGX_TONE_MAPPING",[Pc]:"NEUTRAL_TONE_MAPPING",[Rc]:"CUSTOM_TONE_MAPPING"};function Zp(i,e,t,n,r,s){const a=new Mn(e,t,{type:i,depthBuffer:r,stencilBuffer:s,samples:n?4:0,depthTexture:r?new Qi(e,t):void 0}),o=new Mn(e,t,{type:On,depthBuffer:!1,stencilBuffer:!1}),c=new Nt;c.setAttribute("position",new at([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new at([0,2,0,0,2,0],2));const l=new Gf({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),f=new Qe(c,l),h=new Io(-1,1,1,-1,0,1);let u=null,g=null,x=!1,S,m=null,d=[],y=!1;this.setSize=function(w,M){a.setSize(w,M),o.setSize(w,M);for(let A=0;A<d.length;A++){const b=d[A];b.setSize&&b.setSize(w,M)}},this.setEffects=function(w){d=w,y=d.length>0&&d[0].isRenderPass===!0;const M=a.width,A=a.height;for(let b=0;b<d.length;b++){const R=d[b];R.setSize&&R.setSize(M,A)}},this.begin=function(w,M){if(x||w.toneMapping===vn&&d.length===0)return!1;if(m=M,M!==null){const A=M.width,b=M.height;(a.width!==A||a.height!==b)&&this.setSize(A,b)}return y===!1&&w.setRenderTarget(a),S=w.toneMapping,w.toneMapping=vn,!0},this.hasRenderPass=function(){return y},this.end=function(w,M){w.toneMapping=S,x=!0;let A=a,b=o;for(let R=0;R<d.length;R++){const _=d[R];if(_.enabled!==!1&&(_.render(w,b,A,M),_.needsSwap!==!1)){const E=A;A=b,b=E}}if(u!==w.outputColorSpace||g!==w.toneMapping){u=w.outputColorSpace,g=w.toneMapping,l.defines={},ze.getTransfer(u)===$e&&(l.defines.SRGB_TRANSFER="");const R=$p[g];R&&(l.defines[R]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=A.texture,w.setRenderTarget(m),w.render(f,h),m=null,x=!1},this.isCompositing=function(){return x},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}const jc=new Ot,lo=new Qi(1,1),eu=new Gc,tu=new gf,nu=new Xc,Jl=[],Ql=[],jl=new Float32Array(16),ec=new Float32Array(9),tc=new Float32Array(4);function rr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Jl[r];if(s===void 0&&(s=new Float32Array(r),Jl[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function yt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function bt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function As(i,e){let t=Ql[e];t===void 0&&(t=new Int32Array(e),Ql[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Jp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Qp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;i.uniform2fv(this.addr,e),bt(t,e)}}function jp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(yt(t,e))return;i.uniform3fv(this.addr,e),bt(t,e)}}function em(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;i.uniform4fv(this.addr,e),bt(t,e)}}function tm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),bt(t,e)}else{if(yt(t,n))return;tc.set(n),i.uniformMatrix2fv(this.addr,!1,tc),bt(t,n)}}function nm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),bt(t,e)}else{if(yt(t,n))return;ec.set(n),i.uniformMatrix3fv(this.addr,!1,ec),bt(t,n)}}function im(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(yt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),bt(t,e)}else{if(yt(t,n))return;jl.set(n),i.uniformMatrix4fv(this.addr,!1,jl),bt(t,n)}}function rm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function sm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;i.uniform2iv(this.addr,e),bt(t,e)}}function am(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;i.uniform3iv(this.addr,e),bt(t,e)}}function om(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;i.uniform4iv(this.addr,e),bt(t,e)}}function lm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function cm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;i.uniform2uiv(this.addr,e),bt(t,e)}}function um(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;i.uniform3uiv(this.addr,e),bt(t,e)}}function fm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;i.uniform4uiv(this.addr,e),bt(t,e)}}function dm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(lo.compareFunction=t.isReversedDepthBuffer()?Eo:So,s=lo):s=jc,t.setTexture2D(e||s,r)}function hm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||tu,r)}function pm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||nu,r)}function mm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||eu,r)}function gm(i){switch(i){case 5126:return Jp;case 35664:return Qp;case 35665:return jp;case 35666:return em;case 35674:return tm;case 35675:return nm;case 35676:return im;case 5124:case 35670:return rm;case 35667:case 35671:return sm;case 35668:case 35672:return am;case 35669:case 35673:return om;case 5125:return lm;case 36294:return cm;case 36295:return um;case 36296:return fm;case 35678:case 36198:case 36298:case 36306:case 35682:return dm;case 35679:case 36299:case 36307:return hm;case 35680:case 36300:case 36308:case 36293:return pm;case 36289:case 36303:case 36311:case 36292:return mm}}function _m(i,e){i.uniform1fv(this.addr,e)}function xm(i,e){const t=rr(e,this.size,2);i.uniform2fv(this.addr,t)}function vm(i,e){const t=rr(e,this.size,3);i.uniform3fv(this.addr,t)}function Mm(i,e){const t=rr(e,this.size,4);i.uniform4fv(this.addr,t)}function Sm(i,e){const t=rr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Em(i,e){const t=rr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function ym(i,e){const t=rr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function bm(i,e){i.uniform1iv(this.addr,e)}function Tm(i,e){i.uniform2iv(this.addr,e)}function Am(i,e){i.uniform3iv(this.addr,e)}function wm(i,e){i.uniform4iv(this.addr,e)}function Rm(i,e){i.uniform1uiv(this.addr,e)}function Cm(i,e){i.uniform2uiv(this.addr,e)}function Pm(i,e){i.uniform3uiv(this.addr,e)}function Dm(i,e){i.uniform4uiv(this.addr,e)}function Lm(i,e,t){const n=this.cache,r=e.length,s=As(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),bt(n,s));let a;this.type===i.SAMPLER_2D_SHADOW?a=lo:a=jc;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function Im(i,e,t){const n=this.cache,r=e.length,s=As(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),bt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||tu,s[a])}function Um(i,e,t){const n=this.cache,r=e.length,s=As(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),bt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||nu,s[a])}function Nm(i,e,t){const n=this.cache,r=e.length,s=As(t,r);yt(n,s)||(i.uniform1iv(this.addr,s),bt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||eu,s[a])}function Fm(i){switch(i){case 5126:return _m;case 35664:return xm;case 35665:return vm;case 35666:return Mm;case 35674:return Sm;case 35675:return Em;case 35676:return ym;case 5124:case 35670:return bm;case 35667:case 35671:return Tm;case 35668:case 35672:return Am;case 35669:case 35673:return wm;case 5125:return Rm;case 36294:return Cm;case 36295:return Pm;case 36296:return Dm;case 35678:case 36198:case 36298:case 36306:case 35682:return Lm;case 35679:case 36299:case 36307:return Im;case 35680:case 36300:case 36308:case 36293:return Um;case 36289:case 36303:case 36311:case 36292:return Nm}}class Om{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=gm(t.type)}}class Bm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Fm(t.type)}}class zm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const ca=/(\w+)(\])?(\[|\.)?/g;function nc(i,e){i.seq.push(e),i.map[e.id]=e}function Gm(i,e,t){const n=i.name,r=n.length;for(ca.lastIndex=0;;){const s=ca.exec(n),a=ca.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){nc(t,l===void 0?new Om(o,i,e):new Bm(o,i,e));break}else{let h=t.map[o];h===void 0&&(h=new zm(o),nc(t,h)),t=h}}}class ls{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);Gm(o,c,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function ic(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Vm=37297;let Hm=0;function km(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const rc=new Pe;function Wm(i){ze._getMatrix(rc,ze.workingColorSpace,i);const e=`mat3( ${rc.elements.map(t=>t.toFixed(4))} )`;switch(ze.getTransfer(i)){case ms:return[e,"LinearTransferOETF"];case $e:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function sc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+s+`

`+km(i.getShaderSource(e),o)}else return s}function Xm(i,e){const t=Wm(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const qm={[bc]:"Linear",[Tc]:"Reinhard",[Ac]:"Cineon",[wc]:"ACESFilmic",[Cc]:"AgX",[Pc]:"Neutral",[Rc]:"Custom"};function Ym(i,e){const t=qm[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ns=new U;function Km(){ze.getLuminanceCoefficients(ns);const i=ns.x.toFixed(4),e=ns.y.toFixed(4),t=ns.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Jm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function gr(i){return i!==""}function ac(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function oc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Qm=/^[ \t]*#include +<([\w\d./]+)>/gm;function co(i){return i.replace(Qm,eg)}const jm=new Map;function eg(i,e){let t=Ue[e];if(t===void 0){const n=jm.get(e);if(n!==void 0)t=Ue[n],Re('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return co(t)}const tg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function lc(i){return i.replace(tg,ng)}function ng(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function cc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const ig={[is]:"SHADOWMAP_TYPE_PCF",[mr]:"SHADOWMAP_TYPE_VSM"};function rg(i){return ig[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const sg={[vi]:"ENVMAP_TYPE_CUBE",[Ji]:"ENVMAP_TYPE_CUBE",[Es]:"ENVMAP_TYPE_CUBE_UV"};function ag(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":sg[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const og={[Ji]:"ENVMAP_MODE_REFRACTION"};function lg(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":og[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const cg={[yc]:"ENVMAP_BLENDING_MULTIPLY",[Ku]:"ENVMAP_BLENDING_MIX",[$u]:"ENVMAP_BLENDING_ADD"};function ug(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":cg[i.combine]||"ENVMAP_BLENDING_NONE"}function fg(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function dg(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=rg(t),l=ag(t),f=lg(t),h=ug(t),u=fg(t),g=$m(t),x=Zm(s),S=r.createProgram();let m,d,y=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(m=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,x].filter(gr).join(`
`),m.length>0&&(m+=`
`),d=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,x].filter(gr).join(`
`),d.length>0&&(d+=`
...
}`;class Og{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new qc(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Tn({vertexShader:Ng,fragmentShader:Fg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Qe(new Pr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Bg extends yi{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,f=null,h=null,u=null,g=null,x=null;const S=typeof XRWebGLBinding<"u",m=new Og,d={},y=t.getContextAttributes();let w=null,M=null;const A=[],b=[],R=new Fe;let _=null;const E=new Zt;E.viewport=new lt;const C=new Zt;C.viewport=new lt;const P=[E,C],N=new Kf;let X=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let ie=A[Z];return ie===void 0&&(ie=new Vs,A[Z]=ie),ie.getTargetRaySpace()},this.getControllerGrip=function(Z){let ie=A[Z];return ie===void 0&&(ie=new Vs,A[Z]=ie),ie.getGripSpace()},this.getHand=function(Z){let ie=A[Z];return ie===void 0&&(ie=new Vs,A[Z]=ie),ie.getHandSpace()};function O(Z){const ie=b.indexOf(Z.inputSource);if(ie===-1)return;const ee=A[ie];ee!==void 0&&(ee.update(Z.inputSource,Z.frame,l||a),ee.dispatchEvent({type:Z.type,data:Z.inputSource}))}function q(){r.removeEventListener("select",O),r.removeEventListener("selectstart",O),r.removeEventListener("selectend",O),r.removeEventListener("squeeze",O),r.removeEventListener("squeezestart",O),r.removeEventListener("squeezeend",O),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",V);for(let Z=0;Z<A.length;Z++){const ie=b[Z];ie!==null&&(b[Z]=null,A[Z].disconnect(ie))}X=null,$=null,m.reset();for(const Z in d)delete d[Z];e.setRenderTarget(w),g=null,u=null,h=null,r=null,M=null,Xe.stop(),n.isPresenting=!1,e.setPixelRatio(_),e.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,n.isPresenting===!0&&Re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&Re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Z){l=Z},this.getBaseLayer=function(){return u!==null?u:g},this.getBinding=function(){return h===null&&S&&(h=new XRWebGLBinding(r,t)),h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(Z){if(r=Z,r!==null){if(w=e.getRenderTarget(),r.addEventListener("select",O),r.addEventListener("selectstart",O),r.addEventListener("selectend",O),r.addEventListener("squeeze",O),r.addEventListener("squeezestart",O),r.addEventListener("squeezeend",O),r.addEventListener("end",q),r.addEventListener("inputsourceschange",V),y.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(R),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let ee=null,Ce=null,De=null;y.depth&&(De=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=y.stencil?hi:Bn,Ce=y.stencil?Er:yn);const Te={colorFormat:t.RGBA8,depthFormat:De,scaleFactor:s};h=this.getBinding(),u=h.createProjectionLayer(Te),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),M=new Mn(u.textureWidth,u.textureHeight,{format:on,type:qt,depthTexture:new Qi(u.textureWidth,u.textureHeight,Ce,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const ee={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:s};g=new XRWebGLLayer(r,t,ee),r.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),M=new Mn(g.framebufferWidth,g.framebufferHeight,{format:on,type:qt,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),Xe.setContext(r),Xe.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function V(Z){for(let ie=0;ie<Z.removed.length;ie++){const ee=Z.removed[ie],Ce=b.indexOf(ee);Ce>=0&&(b[Ce]=null,A[Ce].disconnect(ee))}for(let ie=0;ie<Z.added.length;ie++){const ee=Z.added[ie];let Ce=b.indexOf(ee);if(Ce===-1){for(let Te=0;Te<A.length;Te++)if(Te>=b.length){b.push(ee),Ce=Te;break}else if(b[Te]===null){b[Te]=ee,Ce=Te;break}if(Ce===-1)break}const De=A[Ce];De&&De.connect(ee)}}const J=new U,j=new U;function ue(Z,ie,ee){J.setFromMatrixPosition(ie.matrixWorld),j.setFromMatrixPosition(ee.matrixWorld);const Ce=J.distanceTo(j),De=ie.projectionMatrix.elements,Te=ee.projectionMatrix.elements,pt=De[14]/(De[10]-1),Oe=De[14]/(De[10]+1),je=(De[9]+1)/De[5],qe=(De[9]-1)/De[5],He=(De[8]-1)/De[0],_t=(Te[8]+1)/Te[0],St=pt*He,Tt=pt*_t,Rt=Ce/(-He+_t),ut=Rt*-He;if(ie.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(ut),Z.translateZ(Rt),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),De[10]===-1)Z.projectionMatrix.copy(ie.projectionMatrix),Z.projectionMatrixInverse.copy(ie.projectionMatrixInverse);else{const xt=pt+Rt,L=Oe+Rt,zt=St-ut,Ke=Tt+(Ce-ut),T=je*Oe/L*xt,p=qe*Oe/L*xt;Z.projectionMatrix.makePerspective(zt,Ke,T,p,xt,L),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function pe(Z,ie){ie===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(ie.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(r===null)return;let ie=Z.near,ee=Z.far;m.texture!==null&&(m.depthNear>0&&(ie=m.depthNear),m.depthFar>0&&(ee=m.depthFar)),N.near=C.near=E.near=ie,N.far=C.far=E.far=ee,(X!==N.near||$!==N.far)&&(r.updateRenderState({depthNear:N.near,depthFar:N.far}),X=N.near,$=N.far),N.layers.mask=Z.layers.mask|6,E.layers.mask=N.layers.mask&-5,C.layers.mask=N.layers.mask&-3;const Ce=Z.parent,De=N.cameras;pe(N,Ce);for(let Te=0;Te<De.length;Te++)pe(De[Te],Ce);De.length===2?ue(N,E,C):N.projectionMatrix.copy(E.projectionMatrix),_e(Z,N,Ce)};function _e(Z,ie,ee){ee===null?Z.matrix.copy(ie.matrixWorld):(Z.matrix.copy(ee.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(ie.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(ie.projectionMatrix),Z.projectionMatrixInverse.copy(ie.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=so*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(u===null&&g===null))return c},this.setFoveation=function(Z){c=Z,u!==null&&(u.fixedFoveation=Z),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=Z)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function(Z){return d[Z]};let We=null;function ct(Z,ie){if(f=ie.getViewerPose(l||a),x=ie,f!==null){const ee=f.views;g!==null&&(e.setRenderTargetFramebuffer(M,g.framebuffer),e.setRenderTarget(M));let Ce=!1;ee.length!==N.cameras.length&&(N.cameras.length=0,Ce=!0);for(let Oe=0;Oe<ee.length;Oe++){const je=ee[Oe];let qe=null;if(g!==null)qe=g.getViewport(je);else{const _t=h.getViewSubImage(u,je);qe=_t.viewport,Oe===0&&(e.setRenderTargetTextures(M,_t.colorTexture,_t.depthStencilTexture),e.setRenderTarget(M))}let He=P[Oe];He===void 0&&(He=new Zt,He.layers.enable(Oe),He.viewport=new lt,P[Oe]=He),He.matrix.fromArray(je.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(je.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(qe.x,qe.y,qe.width,qe.height),Oe===0&&(N.matrix.copy(He.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Ce===!0&&N.cameras.push(He)}const De=r.enabledFeatures;if(De&&De.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&S){h=n.getBinding();const Oe=h.getDepthInformation(ee[0]);Oe&&Oe.isValid&&Oe.texture&&m.init(Oe,r.renderState)}if(De&&De.includes("camera-access")&&S){e.state.unbindTexture(),h=n.getBinding();for(let Oe=0;Oe<ee.length;Oe++){const je=ee[Oe].camera;if(je){let qe=d[je];qe||(qe=new qc,d[je]=qe);const He=h.getCameraImage(je);qe.sourceTexture=He}}}}for(let ee=0;ee<A.length;ee++){const Ce=b[ee],De=A[ee];Ce!==null&&De!==void 0&&De.update(Ce,ie,l||a)}We&&We(Z,ie),ie.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ie}),x=null}const Xe=new Zc;Xe.setAnimationLoop(ct),this.setAnimationLoop=function(Z){We=Z},this.dispose=function(){}}}const zg=new st,iu=new Pe;iu.set(-1,0,0,0,1,0,0,0,1);function Gg(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,Yc(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,y,w,M){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?s(m,d):d.isMeshLambertMaterial?(s(m,d),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),f(m,d),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(s(m,d),u(m,d),d.isMeshPhysicalMaterial&&g(m,d,M)):d.isMeshMatcapMaterial?(s(m,d),x(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),S(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?c(m,d,y,w):d.isSpriteMaterial?l(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Ht&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Ht&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const y=e.get(d),w=y.envMap,M=y.envMapRotation;w&&(m.envMap.value=w,m.envMapRotation.value.setFromMatrix4(zg.makeRotationFromEuler(M)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(iu),m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function c(m,d,y,w){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*y,m.scale.value=w*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function l(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function f(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function u(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function g(m,d,y){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ht&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,d){d.matcap&&(m.matcap.value=d.matcap)}function S(m,d){const y=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Vg(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(M,A){const b=A.program;n.uniformBlockBinding(M,b)}function l(M,A){let b=r[M.id];b===void 0&&(m(M),b=f(M),r[M.id]=b,M.addEventListener("dispose",y));const R=A.program;n.updateUBOMapping(M,R);const _=e.render.frame;s[M.id]!==_&&(u(M),s[M.id]=_)}function f(M){const A=h();M.__bindingPointIndex=A;const b=i.createBuffer(),R=M.__size,_=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,R,_),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,A,b),b}function h(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return Ve("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(M){const A=r[M.id],b=M.uniforms,R=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,A);for(let _=0,E=b.length;_<E;_++){const C=b[_];if(Array.isArray(C))for(let P=0,N=C.length;P<N;P++)g(C[P],_,P,R);else g(C,_,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function g(M,A,b,R){if(S(M,A,b,R)===!0){const _=M.__offset,E=M.value;if(Array.isArray(E)){let C=0;for(let P=0;P<E.length;P++){const N=E[P],X=d(N);x(N,M.__data,C),typeof N!="number"&&typeof N!="boolean"&&!N.isMatrix3&&!ArrayBuffer.isView(N)&&(C+=X.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(E,M.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,_,M.__data)}}function x(M,A,b){typeof M=="number"||typeof M=="boolean"?A[0]=M:M.isMatrix3?(A[0]=M.elements[0],A[1]=M.elements[1],A[2]=M.elements[2],A[3]=0,A[4]=M.elements[3],A[5]=M.elements[4],A[6]=M.elements[5],A[7]=0,A[8]=M.elements[6],A[9]=M.elements[7],A[10]=M.elements[8],A[11]=0):ArrayBuffer.isView(M)?A.set(new M.constructor(M.buffer,M.byteOffset,A.length)):M.toArray(A,b)}function S(M,A,b,R){const _=M.value,E=A+"_"+b;if(R[E]===void 0)return typeof _=="number"||typeof _=="boolean"?R[E]=_:ArrayBuffer.isView(_)?R[E]=_.slice():R[E]=_.clone(),!0;{const C=R[E];if(typeof _=="number"||typeof _=="boolean"){if(C!==_)return R[E]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(C.equals(_)===!1)return C.copy(_),!0}}return!1}function m(M){const A=M.uniforms;let b=0;const R=16;for(let E=0,C=A.length;E<C;E++){const P=Array.isArray(A[E])?A[E]:[A[E]];for(let N=0,X=P.length;N<X;N++){const $=P[N],O=Array.isArray($.value)?$.value:[$.value];for(let q=0,V=O.length;q<V;q++){const J=O[q],j=d(J),ue=b%R,pe=ue%j.boundary,_e=ue+pe;b+=pe,_e!==0&&R-_e<j.storage&&(b+=R-_e),$.__data=new Float32Array(j.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=b,b+=j.storage}}}const _=b%R;return _>0&&(b+=R-_),M.__size=b,M.__cache={},this}function d(M){const A={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(A.boundary=4,A.storage=4):M.isVector2?(A.boundary=8,A.storage=8):M.isVector3||M.isColor?(A.boundary=16,A.storage=12):M.isVector4?(A.boundary=16,A.storage=16):M.isMatrix3?(A.boundary=48,A.storage=48):M.isMatrix4?(A.boundary=64,A.storage=64):M.isTexture?Re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(A.boundary=16,A.storage=M.byteLength):Re("WebGLRenderer: Unsupported uniform value type.",M),A}function y(M){const A=M.target;A.removeEventListener("dispose",y);const b=a.indexOf(A.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function w(){for(const M in r)i.deleteBuffer(r[M]);a=[],r={},s={}}return{bind:c,update:l,dispose:w}}const Hg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let pn=null;function kg(){return pn===null&&(pn=new Pf(Hg,16,16,Mi,On),pn.name="DFG_LUT",pn.minFilter=It,pn.magFilter=It,pn.wrapS=In,pn.wrapT=In,pn.generateMipmaps=!1,pn.needsUpdate=!0),pn}class Wg{constructor(e={}){const{canvas:t=of(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:u=!1,outputBufferType:g=qt}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=a;const S=g,m=new Set([Mo,vo,xo]),d=new Set([qt,yn,Sr,Er,go,_o]),y=new Uint32Array(4),w=new Int32Array(4),M=new U;let A=null,b=null;const R=[],_=[];let E=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=vn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const C=this;let P=!1,N=null,X=null,$=null,O=null;this._outputColorSpace=$t;let q=0,V=0,J=null,j=-1,ue=null;const pe=new lt,_e=new lt;let We=null;const ct=new Be(0);let Xe=0,Z=t.width,ie=t.height,ee=1,Ce=null,De=null;const Te=new lt(0,0,Z,ie),pt=new lt(0,0,Z,ie);let Oe=!1;const je=new wo;let qe=!1,He=!1;const _t=new st,St=new U,Tt=new lt,Rt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ut=!1;function xt(){return J===null?ee:1}let L=n;function zt(v,I){return t.getContext(v,I)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${po}`),t.addEventListener("webglcontextlost",ft,!1),t.addEventListener("webglcontextrestored",nt,!1),t.addEventListener("webglcontextcreationerror",un,!1),L===null){const I="webgl2";if(L=zt(I,v),L===null)throw zt(I)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(v){throw Ve("WebGLRenderer: "+v.message),v}let Ke,T,p,F,G,k,te,re,W,K,se,Se,le,ae,be,Ae,Le,D,ne,Y,oe,he,Q;function Me(){Ke=new kp(L),Ke.init(),oe=new Ug(L,Ke),T=new Np(L,Ke,e,oe),p=new Lg(L,Ke),T.reversedDepthBuffer&&u&&p.buffers.depth.setReversed(!0),X=L.createFramebuffer(),$=L.createFramebuffer(),O=L.createFramebuffer(),F=new qp(L),G=new xg,k=new Ig(L,Ke,p,G,T,oe,F),te=new Hp(C),re=new Zf(L),he=new Ip(L,re),W=new Wp(L,re,F,he),K=new Kp(L,W,re,he,F),D=new Yp(L,T,k),be=new Fp(G),se=new _g(C,te,Ke,T,he,be),Se=new Gg(C,G),le=new Mg,ae=new Ag(Ke),Le=new Lp(C,te,p,K,x,c),Ae=new Dg(C,K,T),Q=new Vg(L,F,T,p),ne=new Up(L,Ke,F),Y=new Xp(L,Ke,F),F.programs=se.programs,C.capabilities=T,C.extensions=Ke,C.properties=G,C.renderLists=le,C.shadowMap=Ae,C.state=p,C.info=F}Me(),S!==qt&&(E=new Zp(S,t.width,t.height,o,r,s));const xe=new Bg(C,L);this.xr=xe,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const v=Ke.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Ke.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return ee},this.setPixelRatio=function(v){v!==void 0&&(ee=v,this.setSize(Z,ie,!1))},this.getSize=function(v){return v.set(Z,ie)},this.setSize=function(v,I,H=!0){if(xe.isPresenting){Re("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=v,ie=I,t.width=Math.floor(v*ee),t.height=Math.floor(I*ee),H===!0&&(t.style.width=v+"px",t.style.height=I+"px"),E!==null&&E.setSize(t.width,t.height),this.setViewport(0,0,v,I)},this.getDrawingBufferSize=function(v){return v.set(Z*ee,ie*ee).floor()},this.setDrawingBufferSize=function(v,I,H){Z=v,ie=I,ee=H,t.width=Math.floor(v*H),t.height=Math.floor(I*H),this.setViewport(0,0,v,I)},this.setEffects=function(v){if(S===qt){Ve("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let I=0;I<v.length;I++)if(v[I].isOutputPass===!0){Re("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}E.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(pe)},this.getViewport=function(v){return v.copy(Te)},this.setViewport=function(v,I,H,B){v.isVector4?Te.set(v.x,v.y,v.z,v.w):Te.set(v,I,H,B),p.viewport(pe.copy(Te).multiplyScalar(ee).round())},this.getScissor=function(v){return v.copy(pt)},this.setScissor=function(v,I,H,B){v.isVector4?pt.set(v.x,v.y,v.z,v.w):pt.set(v,I,H,B),p.scissor(_e.copy(pt).multiplyScalar(ee).round())},this.getScissorTest=function(){return Oe},this.setScissorTest=function(v){p.setScissorTest(Oe=v)},this.setOpaqueSort=function(v){Ce=v},this.setTransparentSort=function(v){De=v},this.getClearColor=function(v){return v.copy(Le.getClearColor())},this.setClearColor=function(){Le.setClearColor(...arguments)},this.getClearAlpha=function(){return Le.getClearAlpha()},this.setClearAlpha=function(){Le.setClearAlpha(...arguments)},this.clear=function(v=!0,I=!0,H=!0){let B=0;if(v){let z=!1;if(J!==null){const de=J.texture.format;z=m.has(de)}if(z){const de=J.texture.type,ge=d.has(de),fe=Le.getClearColor(),ve=Le.getClearAlpha(),Ee=fe.r,Ie=fe.g,Ne=fe.b;ge?(y[0]=Ee,y[1]=Ie,y[2]=Ne,y[3]=ve,L.clearBufferuiv(L.COLOR,0,y)):(w[0]=Ee,w[1]=Ie,w[2]=Ne,w[3]=ve,L.clearBufferiv(L.COLOR,0,w))}else B|=L.COLOR_BUFFER_BIT}I&&(B|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),H&&(B|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&L.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),N=v},this.dispose=function(){t.removeEventListener("webglcontextlost",ft,!1),t.removeEventListener("webglcontextrestored",nt,!1),t.removeEventListener("webglcontextcreationerror",un,!1),Le.dispose(),le.dispose(),ae.dispose(),G.dispose(),te.dispose(),K.dispose(),he.dispose(),Q.dispose(),se.dispose(),xe.dispose(),xe.removeEventListener("sessionstart",il),xe.removeEventListener("sessionend",rl),ni.stop()};function ft(v){v.preventDefault(),vl("WebGLRenderer: Context Lost."),P=!0}function nt(){vl("WebGLRenderer: Context Restored."),P=!1;const v=F.autoReset,I=Ae.enabled,H=Ae.autoUpdate,B=Ae.needsUpdate,z=Ae.type;Me(),F.autoReset=v,Ae.enabled=I,Ae.autoUpdate=H,Ae.needsUpdate=B,Ae.type=z}function un(v){Ve("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function fn(v){const I=v.target;I.removeEventListener("dispose",fn),Mu(I)}function Mu(v){Su(v),G.remove(v)}function Su(v){const I=G.get(v).programs;I!==void 0&&(I.forEach(function(H){se.releaseProgram(H)}),v.isShaderMaterial&&se.releaseShaderCache(v))}this.renderBufferDirect=function(v,I,H,B,z,de){I===null&&(I=Rt);const ge=z.isMesh&&z.matrixWorld.determinantAffine()<0,fe=bu(v,I,H,B,z);p.setMaterial(B,ge);let ve=H.index,Ee=1;if(B.wireframe===!0){if(ve=W.getWireframeAttribute(H),ve===void 0)return;Ee=2}const Ie=H.drawRange,Ne=H.attributes.position;let ye=Ie.start*Ee,Ze=(Ie.start+Ie.count)*Ee;de!==null&&(ye=Math.max(ye,de.start*Ee),Ze=Math.min(Ze,(de.start+de.count)*Ee)),ve!==null?(ye=Math.max(ye,0),Ze=Math.min(Ze,ve.count)):Ne!=null&&(ye=Math.max(ye,0),Ze=Math.min(Ze,Ne.count));const mt=Ze-ye;if(mt<0||mt===1/0)return;he.setup(z,B,fe,H,ve);let dt,et=ne;if(ve!==null&&(dt=re.get(ve),et=Y,et.setIndex(dt)),z.isMesh)B.wireframe===!0?(p.setLineWidth(B.wireframeLinewidth*xt()),et.setMode(L.LINES)):et.setMode(L.TRIANGLES);else if(z.isLine){let Pt=B.linewidth;Pt===void 0&&(Pt=1),p.setLineWidth(Pt*xt()),z.isLineSegments?et.setMode(L.LINES):z.isLineLoop?et.setMode(L.LINE_LOOP):et.setMode(L.LINE_STRIP)}else z.isPoints?et.setMode(L.POINTS):z.isSprite&&et.setMode(L.TRIANGLES);if(z.isBatchedMesh)if(Ke.get("WEBGL_multi_draw"))et.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Pt=z._multiDrawStarts,me=z._multiDrawCounts,kt=z._multiDrawCount,ke=ve?re.get(ve).bytesPerElement:1,Yt=G.get(B).currentProgram.getUniforms();for(let dn=0;dn<kt;dn++)Yt.setValue(L,"_gl_DrawID",dn),et.render(Pt[dn]/ke,me[dn])}else if(z.isInstancedMesh)et.renderInstances(ye,mt,z.count);else if(H.isInstancedBufferGeometry){const Pt=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,me=Math.min(H.instanceCount,Pt);et.renderInstances(ye,mt,me)}else et.render(ye,mt)};function nl(v,I,H){v.transparent===!0&&v.side===Dn&&v.forceSinglePass===!1?(v.side=Ht,v.needsUpdate=!0,Lr(v,I,H),v.side=jn,v.needsUpdate=!0,Lr(v,I,H),v.side=Dn):Lr(v,I,H)}this.compile=function(v,I,H=null){H===null&&(H=v),b=ae.get(H),b.init(I),_.push(b),H.traverseVisible(function(z){z.isLight&&z.layers.test(I.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),v!==H&&v.traverseVisible(function(z){z.isLight&&z.layers.test(I.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),b.setupLights();const B=new Set;return v.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const de=z.material;if(de)if(Array.isArray(de))for(let ge=0;ge<de.length;ge++){const fe=de[ge];nl(fe,H,z),B.add(fe)}else nl(de,H,z),B.add(de)}),b=_.pop(),B},this.compileAsync=function(v,I,H=null){const B=this.compile(v,I,H);return new Promise(z=>{function de(){if(B.forEach(function(ge){G.get(ge).currentProgram.isReady()&&B.delete(ge)}),B.size===0){z(v);return}setTimeout(de,10)}Ke.get("KHR_parallel_shader_compile")!==null?de():setTimeout(de,10)})};let Cs=null;function Eu(v){Cs&&Cs(v)}function il(){ni.stop()}function rl(){ni.start()}const ni=new Zc;ni.setAnimationLoop(Eu),typeof self<"u"&&ni.setContext(self),this.setAnimationLoop=function(v){Cs=v,xe.setAnimationLoop(v),v===null?ni.stop():ni.start()},xe.addEventListener("sessionstart",il),xe.addEventListener("sessionend",rl),this.render=function(v,I){if(I!==void 0&&I.isCamera!==!0){Ve("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;N!==null&&N.renderStart(v,I);const H=xe.enabled===!0&&xe.isPresenting===!0,B=E!==null&&(J===null||H)&&E.begin(C,J);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),xe.enabled===!0&&xe.isPresenting===!0&&(E===null||E.isCompositing()===!1)&&(xe.cameraAutoUpdate===!0&&xe.updateCamera(I),I=xe.getCamera()),v.isScene===!0&&v.onBeforeRender(C,v,I,J),b=ae.get(v,_.length),b.init(I),b.state.textureUnits=k.getTextureUnits(),_.push(b),_t.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),je.setFromProjectionMatrix(_t,xn,I.reversedDepth),He=this.localClippingEnabled,qe=be.init(this.clippingPlanes,He),A=le.get(v,R.length),A.init(),R.push(A),xe.enabled===!0&&xe.isPresenting===!0){const ge=C.xr.getDepthSensingMesh();ge!==null&&Ps(ge,I,-1/0,C.sortObjects)}Ps(v,I,0,C.sortObjects),A.finish(),C.sortObjects===!0&&A.sort(Ce,De,I.reversedDepth),ut=xe.enabled===!1||xe.isPresenting===!1||xe.hasDepthSensing()===!1,ut&&Le.addToRenderList(A,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),qe===!0&&be.beginShadows();const z=b.state.shadowsArray;if(Ae.render(z,v,I),qe===!0&&be.endShadows(),(B&&E.hasRenderPass())===!1){const ge=A.opaque,fe=A.transmissive;if(b.setupLights(),I.isArrayCamera){const ve=I.cameras;if(fe.length>0)for(let Ee=0,Ie=ve.length;Ee<Ie;Ee++){const Ne=ve[Ee];al(ge,fe,v,Ne)}ut&&Le.render(v);for(let Ee=0,Ie=ve.length;Ee<Ie;Ee++){const Ne=ve[Ee];sl(A,v,Ne,Ne.viewport)}}else fe.length>0&&al(ge,fe,v,I),ut&&Le.render(v),sl(A,v,I)}J!==null&&V===0&&(k.updateMultisampleRenderTarget(J),k.updateRenderTargetMipmap(J)),B&&E.end(C),v.isScene===!0&&v.onAfterRender(C,v,I),he.resetDefaultState(),j=-1,ue=null,_.pop(),_.length>0?(b=_[_.length-1],k.setTextureUnits(b.state.textureUnits),qe===!0&&be.setGlobalState(C.clippingPlanes,b.state.camera)):b=null,R.pop(),R.length>0?A=R[R.length-1]:A=null,N!==null&&N.renderEnd()};function Ps(v,I,H,B){if(v.visible===!1)return;if(v.layers.test(I.layers)){if(v.isGroup)H=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(I);else if(v.isLightProbeGrid)b.pushLightProbeGrid(v);else if(v.isLight)b.pushLight(v),v.castShadow&&b.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||je.intersectsSprite(v)){B&&Tt.setFromMatrixPosition(v.matrixWorld).applyMatrix4(_t);const ge=K.update(v),fe=v.material;fe.visible&&A.push(v,ge,fe,H,Tt.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||je.intersectsObject(v))){const ge=K.update(v),fe=v.material;if(B&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Tt.copy(v.boundingSphere.center)):(ge.boundingSphere===null&&ge.computeBoundingSphere(),Tt.copy(ge.boundingSphere.center)),Tt.applyMatrix4(v.matrixWorld).applyMatrix4(_t)),Array.isArray(fe)){const ve=ge.groups;for(let Ee=0,Ie=ve.length;Ee<Ie;Ee++){const Ne=ve[Ee],ye=fe[Ne.materialIndex];ye&&ye.visible&&A.push(v,ge,ye,H,Tt.z,Ne)}}else fe.visible&&A.push(v,ge,fe,H,Tt.z,null)}}const de=v.children;for(let ge=0,fe=de.length;ge<fe;ge++)Ps(de[ge],I,H,B)}function sl(v,I,H,B){const{opaque:z,transmissive:de,transparent:ge}=v;b.setupLightsView(H),qe===!0&&be.setGlobalState(C.clippingPlanes,H),B&&p.viewport(pe.copy(B)),z.length>0&&Dr(z,I,H),de.length>0&&Dr(de,I,H),ge.length>0&&Dr(ge,I,H),p.buffers.depth.setTest(!0),p.buffers.depth.setMask(!0),p.buffers.color.setMask(!0),p.setPolygonOffset(!1)}function al(v,I,H,B){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[B.id]===void 0){const ye=Ke.has("EXT_color_buffer_half_float")||Ke.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[B.id]=new Mn(1,1,{generateMipmaps:!0,type:ye?On:qt,minFilter:di,samples:Math.max(4,T.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ze.workingColorSpace})}const de=b.state.transmissionRenderTarget[B.id],ge=B.viewport||pe;de.setSize(ge.z*C.transmissionResolutionScale,ge.w*C.transmissionResolutionScale);const fe=C.getRenderTarget(),ve=C.getActiveCubeFace(),Ee=C.getActiveMipmapLevel();C.setRenderTarget(de),C.getClearColor(ct),Xe=C.getClearAlpha(),Xe<1&&C.setClearColor(16777215,.5),C.clear(),ut&&Le.render(H);const Ie=C.toneMapping;C.toneMapping=vn;const Ne=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),b.setupLightsView(B),qe===!0&&be.setGlobalState(C.clippingPlanes,B),Dr(v,H,B),k.updateMultisampleRenderTarget(de),k.updateRenderTargetMipmap(de),Ke.has("WEBGL_multisampled_render_to_texture")===!1){let ye=!1;for(let Ze=0,mt=I.length;Ze<mt;Ze++){const dt=I[Ze],{object:et,geometry:Pt,material:me,group:kt}=dt;if(me.side===Dn&&et.layers.test(B.layers)){const ke=me.side;me.side=Ht,me.needsUpdate=!0,ol(et,H,B,Pt,me,kt),me.side=ke,me.needsUpdate=!0,ye=!0}}ye===!0&&(k.updateMultisampleRenderTarget(de),k.updateRenderTargetMipmap(de))}C.setRenderTarget(fe,ve,Ee),C.setClearColor(ct,Xe),Ne!==void 0&&(B.viewport=Ne),C.toneMapping=Ie}function Dr(v,I,H){const B=I.isScene===!0?I.overrideMaterial:null;for(let z=0,de=v.length;z<de;z++){const ge=v[z],{object:fe,geometry:ve,group:Ee}=ge;let Ie=ge.material;Ie.allowOverride===!0&&B!==null&&(Ie=B),fe.layers.test(H.layers)&&ol(fe,I,H,ve,Ie,Ee)}}function ol(v,I,H,B,z,de){v.onBeforeRender(C,I,H,B,z,de),v.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),z.onBeforeRender(C,I,H,B,v,de),z.transparent===!0&&z.side===Dn&&z.forceSinglePass===!1?(z.side=Ht,z.needsUpdate=!0,C.renderBufferDirect(H,I,B,z,v,de),z.side=jn,z.needsUpdate=!0,C.renderBufferDirect(H,I,B,z,v,de),z.side=Dn):C.renderBufferDirect(H,I,B,z,v,de),v.onAfterRender(C,I,H,B,z,de)}function Lr(v,I,H){I.isScene!==!0&&(I=Rt);const B=G.get(v),z=b.state.lights,de=b.state.shadowsArray,ge=z.state.version,fe=se.getParameters(v,z.state,de,I,H,b.state.lightProbeGridArray),ve=se.getProgramCacheKey(fe);let Ee=B.programs;B.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?I.environment:null,B.fog=I.fog;const Ie=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;B.envMap=te.get(v.envMap||B.environment,Ie),B.envMapRotation=B.environment!==null&&v.envMap===null?I.environmentRotation:v.envMapRotation,Ee===void 0&&(v.addEventListener("dispose",fn),Ee=new Map,B.programs=Ee);let Ne=Ee.get(ve);if(Ne!==void 0){if(B.currentProgram===Ne&&B.lightsStateVersion===ge)return cl(v,fe),Ne}else fe.uniforms=se.getUniforms(v),N!==null&&v.isNodeMaterial&&N.build(v,H,fe),v.onBeforeCompile(fe,C),Ne=se.acquireProgram(fe,ve),Ee.set(ve,Ne),B.uniforms=fe.uniforms;const ye=B.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(ye.clippingPlanes=be.uniform),cl(v,fe),B.needsLights=Au(v),B.lightsStateVersion=ge,B.needsLights&&(ye.ambientLightColor.value=z.state.ambient,ye.lightProbe.value=z.state.probe,ye.directionalLights.value=z.state.directional,ye.directionalLightShadows.value=z.state.directionalShadow,ye.spotLights.value=z.state.spot,ye.spotLightShadows.value=z.state.spotShadow,ye.rectAreaLights.value=z.state.rectArea,ye.ltc_1.value=z.state.rectAreaLTC1,ye.ltc_2.value=z.state.rectAreaLTC2,ye.pointLights.value=z.state.point,ye.pointLightShadows.value=z.state.pointShadow,ye.hemisphereLights.value=z.state.hemi,ye.directionalShadowMatrix.value=z.state.directionalShadowMatrix,ye.spotLightMatrix.value=z.state.spotLightMatrix,ye.spotLightMap.value=z.state.spotLightMap,ye.pointShadowMatrix.value=z.state.pointShadowMatrix),B.lightProbeGrid=b.state.lightProbeGridArray.length>0,B.currentProgram=Ne,B.uniformsList=null,Ne}function ll(v){if(v.uniformsList===null){const I=v.currentProgram.getUniforms();v.uniformsList=ls.seqWithValue(I.seq,v.uniforms)}return v.uniformsList}function cl(v,I){const H=G.get(v);H.outputColorSpace=I.outputColorSpace,H.batching=I.batching,H.batchingColor=I.batchingColor,H.instancing=I.instancing,H.instancingColor=I.instancingColor,H.instancingMorph=I.instancingMorph,H.skinning=I.skinning,H.morphTargets=I.morphTargets,H.morphNormals=I.morphNormals,H.morphColors=I.morphColors,H.morphTargetsCount=I.morphTargetsCount,H.numClippingPlanes=I.numClippingPlanes,H.numIntersection=I.numClipIntersection,H.vertexAlphas=I.vertexAlphas,H.vertexTangents=I.vertexTangents,H.toneMapping=I.toneMapping}function yu(v,I){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;M.setFromMatrixPosition(I.matrixWorld);for(let H=0,B=v.length;H<B;H++){const z=v[H];if(z.texture!==null&&z.boundingBox.containsPoint(M))return z}return null}function bu(v,I,H,B,z){I.isScene!==!0&&(I=Rt),k.resetTextureUnits();const de=I.fog,ge=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?I.environment:null,fe=J===null?C.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:ze.workingColorSpace,ve=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Ee=te.get(B.envMap||ge,ve),Ie=B.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Ne=!!H.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),ye=!!H.morphAttributes.position,Ze=!!H.morphAttributes.normal,mt=!!H.morphAttributes.color;let dt=vn;B.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(dt=C.toneMapping);const et=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,Pt=et!==void 0?et.length:0,me=G.get(B),kt=b.state.lights;if(qe===!0&&(He===!0||v!==ue)){const it=v===ue&&B.id===j;be.setState(B,v,it)}let ke=!1;B.version===me.__version?(me.needsLights&&me.lightsStateVersion!==kt.state.version||me.outputColorSpace!==fe||z.isBatchedMesh&&me.batching===!1||!z.isBatchedMesh&&me.batching===!0||z.isBatchedMesh&&me.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&me.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&me.instancing===!1||!z.isInstancedMesh&&me.instancing===!0||z.isSkinnedMesh&&me.skinning===!1||!z.isSkinnedMesh&&me.skinning===!0||z.isInstancedMesh&&me.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&me.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&me.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&me.instancingMorph===!1&&z.morphTexture!==null||me.envMap!==Ee||B.fog===!0&&me.fog!==de||me.numClippingPlanes!==void 0&&(me.numClippingPlanes!==be.numPlanes||me.numIntersection!==be.numIntersection)||me.vertexAlphas!==Ie||me.vertexTangents!==Ne||me.morphTargets!==ye||me.morphNormals!==Ze||me.morphColors!==mt||me.toneMapping!==dt||me.morphTargetsCount!==Pt||!!me.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(ke=!0):(ke=!0,me.__version=B.version);let Yt=me.currentProgram;ke===!0&&(Yt=Lr(B,I,z),N&&B.isNodeMaterial&&N.onUpdateProgram(B,Yt,me));let dn=!1,Vn=!1,wi=!1;const tt=Yt.getUniforms(),gt=me.uniforms;if(p.useProgram(Yt.program)&&(dn=!0,Vn=!0,wi=!0),B.id!==j&&(j=B.id,Vn=!0),me.needsLights){const it=yu(b.state.lightProbeGridArray,z);me.lightProbeGrid!==it&&(me.lightProbeGrid=it,Vn=!0)}if(dn||ue!==v){p.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),tt.setValue(L,"projectionMatrix",v.projectionMatrix),tt.setValue(L,"viewMatrix",v.matrixWorldInverse);const kn=tt.map.cameraPosition;kn!==void 0&&kn.setValue(L,St.setFromMatrixPosition(v.matrixWorld)),T.logarithmicDepthBuffer&&tt.setValue(L,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&tt.setValue(L,"isOrthographic",v.isOrthographicCamera===!0),ue!==v&&(ue=v,Vn=!0,wi=!0)}if(me.needsLights&&(kt.state.directionalShadowMap.length>0&&tt.setValue(L,"directionalShadowMap",kt.state.directionalShadowMap,k),kt.state.spotShadowMap.length>0&&tt.setValue(L,"spotShadowMap",kt.state.spotShadowMap,k),kt.state.pointShadowMap.length>0&&tt.setValue(L,"pointShadowMap",kt.state.pointShadowMap,k)),z.isSkinnedMesh){tt.setOptional(L,z,"bindMatrix"),tt.setOptional(L,z,"bindMatrixInverse");const it=z.skeleton;it&&(it.boneTexture===null&&it.computeBoneTexture(),tt.setValue(L,"boneTexture",it.boneTexture,k))}z.isBatchedMesh&&(tt.setOptional(L,z,"batchingTexture"),tt.setValue(L,"batchingTexture",z._matricesTexture,k),tt.setOptional(L,z,"batchingIdTexture"),tt.setValue(L,"batchingIdTexture",z._indirectTexture,k),tt.setOptional(L,z,"batchingColorTexture"),z._colorsTexture!==null&&tt.setValue(L,"batchingColorTexture",z._colorsTexture,k));const Hn=H.morphAttributes;if((Hn.position!==void 0||Hn.normal!==void 0||Hn.color!==void 0)&&D.update(z,H,Yt),(Vn||me.receiveShadow!==z.receiveShadow)&&(me.receiveShadow=z.receiveShadow,tt.setValue(L,"receiveShadow",z.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&I.environment!==null&&(gt.envMapIntensity.value=I.environmentIntensity),gt.dfgLUT!==void 0&&(gt.dfgLUT.value=kg()),Vn){if(tt.setValue(L,"toneMappingExposure",C.toneMappingExposure),me.needsLights&&Tu(gt,wi),de&&B.fog===!0&&Se.refreshFogUniforms(gt,de),Se.refreshMaterialUniforms(gt,B,ee,ie,b.state.transmissionRenderTarget[v.id]),me.needsLights&&me.lightProbeGrid){const it=me.lightProbeGrid;gt.probesSH.value=it.texture,gt.probesMin.value.copy(it.boundingBox.min),gt.probesMax.value.copy(it.boundingBox.max),gt.probesResolution.value.copy(it.resolution)}ls.upload(L,ll(me),gt,k)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(ls.upload(L,ll(me),gt,k),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&tt.setValue(L,"center",z.center),tt.setValue(L,"modelViewMatrix",z.modelViewMatrix),tt.setValue(L,"normalMatrix",z.normalMatrix),tt.setValue(L,"modelMatrix",z.matrixWorld),B.uniformsGroups!==void 0){const it=B.uniformsGroups;for(let kn=0,Ri=it.length;kn<Ri;kn++){const ul=it[kn];Q.update(ul,Yt),Q.bind(ul,Yt)}}return Yt}function Tu(v,I){v.ambientLightColor.needsUpdate=I,v.lightProbe.needsUpdate=I,v.directionalLights.needsUpdate=I,v.directionalLightShadows.needsUpdate=I,v.pointLights.needsUpdate=I,v.pointLightShadows.needsUpdate=I,v.spotLights.needsUpdate=I,v.spotLightShadows.needsUpdate=I,v.rectAreaLights.needsUpdate=I,v.hemisphereLights.needsUpdate=I}function Au(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return q},this.getActiveMipmapLevel=function(){return V},this.getRenderTarget=function(){return J},this.setRenderTargetTextures=function(v,I,H){const B=G.get(v);B.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),G.get(v.texture).__webglTexture=I,G.get(v.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:H,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,I){const H=G.get(v);H.__webglFramebuffer=I,H.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(v,I=0,H=0){J=v,q=I,V=H;let B=null,z=!1,de=!1;if(v){const fe=G.get(v);if(fe.__useDefaultFramebuffer!==void 0){p.bindFramebuffer(L.FRAMEBUFFER,fe.__webglFramebuffer),pe.copy(v.viewport),_e.copy(v.scissor),We=v.scissorTest,p.viewport(pe),p.scissor(_e),p.setScissorTest(We),j=-1;return}else if(fe.__webglFramebuffer===void 0)k.setupRenderTarget(v);else if(fe.__hasExternalTextures)k.rebindTextures(v,G.get(v.texture).__webglTexture,G.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Ie=v.depthTexture;if(fe.__boundDepthTexture!==Ie){if(Ie!==null&&G.has(Ie)&&(v.width!==Ie.image.width||v.height!==Ie.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");k.setupDepthRenderbuffer(v)}}const ve=v.texture;(ve.isData3DTexture||ve.isDataArrayTexture||ve.isCompressedArrayTexture)&&(de=!0);const Ee=G.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ee[I])?B=Ee[I][H]:B=Ee[I],z=!0):v.samples>0&&k.useMultisampledRTT(v)===!1?B=G.get(v).__webglMultisampledFramebuffer:Array.isArray(Ee)?B=Ee[H]:B=Ee,pe.copy(v.viewport),_e.copy(v.scissor),We=v.scissorTest}else pe.copy(Te).multiplyScalar(ee).floor(),_e.copy(pt).multiplyScalar(ee).floor(),We=Oe;if(H!==0&&(B=X),p.bindFramebuffer(L.FRAMEBUFFER,B)&&p.drawBuffers(v,B),p.viewport(pe),p.scissor(_e),p.setScissorTest(We),z){const fe=G.get(v.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+I,fe.__webglTexture,H)}else if(de){const fe=I;for(let ve=0;ve<v.textures.length;ve++){const Ee=G.get(v.textures[ve]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+ve,Ee.__webglTexture,H,fe)}}else if(v!==null&&H!==0){const fe=G.get(v.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,fe.__webglTexture,H)}j=-1},this.readRenderTargetPixels=function(v,I,H,B,z,de,ge,fe=0){if(!(v&&v.isWebGLRenderTarget)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=G.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ge!==void 0&&(ve=ve[ge]),ve){p.bindFramebuffer(L.FRAMEBUFFER,ve);try{const Ee=v.textures[fe],Ie=Ee.format,Ne=Ee.type;if(v.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+fe),!T.textureFormatReadable(Ie)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!T.textureTypeReadable(Ne)){Ve("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=v.width-B&&H>=0&&H<=v.height-z&&L.readPixels(I,H,B,z,oe.convert(Ie),oe.convert(Ne),de)}finally{const Ee=J!==null?G.get(J).__webglFramebuffer:null;p.bindFramebuffer(L.FRAMEBUFFER,Ee)}}},this.readRenderTargetPixelsAsync=async function(v,I,H,B,z,de,ge,fe=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=G.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ge!==void 0&&(ve=ve[ge]),ve)if(I>=0&&I<=v.width-B&&H>=0&&H<=v.height-z){p.bindFramebuffer(L.FRAMEBUFFER,ve);const Ee=v.textures[fe],Ie=Ee.format,Ne=Ee.type;if(v.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+fe),!T.textureFormatReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!T.textureTypeReadable(Ne))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ye=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,ye),L.bufferData(L.PIXEL_PACK_BUFFER,de.byteLength,L.STREAM_READ),L.readPixels(I,H,B,z,oe.convert(Ie),oe.convert(Ne),0);const Ze=J!==null?G.get(J).__webglFramebuffer:null;p.bindFramebuffer(L.FRAMEBUFFER,Ze);const mt=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await lf(L,mt,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,ye),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,de),L.deleteBuffer(ye),L.deleteSync(mt),de}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,I=null,H=0){const B=Math.pow(2,-H),z=Math.floor(v.image.width*B),de=Math.floor(v.image.height*B),ge=I!==null?I.x:0,fe=I!==null?I.y:0;k.setTexture2D(v,0),L.copyTexSubImage2D(L.TEXTURE_2D,H,0,0,ge,fe,z,de),p.unbindTexture()},this.copyTextureToTexture=function(v,I,H=null,B=null,z=0,de=0){let ge,fe,ve,Ee,Ie,Ne,ye,Ze,mt;const dt=v.isCompressedTexture?v.mipmaps[de]:v.image;if(H!==null)ge=H.max.x-H.min.x,fe=H.max.y-H.min.y,ve=H.isBox3?H.max.z-H.min.z:1,Ee=H.min.x,Ie=H.min.y,Ne=H.isBox3?H.min.z:0;else{const gt=Math.pow(2,-z);ge=Math.floor(dt.width*gt),fe=Math.floor(dt.height*gt),v.isDataArrayTexture?ve=dt.depth:v.isData3DTexture?ve=Math.floor(dt.depth*gt):ve=1,Ee=0,Ie=0,Ne=0}B!==null?(ye=B.x,Ze=B.y,mt=B.z):(ye=0,Ze=0,mt=0);const et=oe.convert(I.format),Pt=oe.convert(I.type);let me;I.isData3DTexture?(k.setTexture3D(I,0),me=L.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(k.setTexture2DArray(I,0),me=L.TEXTURE_2D_ARRAY):(k.setTexture2D(I,0),me=L.TEXTURE_2D),p.activeTexture(L.TEXTURE0),p.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,I.flipY),p.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),p.pixelStorei(L.UNPACK_ALIGNMENT,I.unpackAlignment);const kt=p.getParameter(L.UNPACK_ROW_LENGTH),ke=p.getParameter(L.UNPACK_IMAGE_HEIGHT),Yt=p.getParameter(L.UNPACK_SKIP_PIXELS),dn=p.getParameter(L.UNPACK_SKIP_ROWS),Vn=p.getParameter(L.UNPACK_SKIP_IMAGES);p.pixelStorei(L.UNPACK_ROW_LENGTH,dt.width),p.pixelStorei(L.UNPACK_IMAGE_HEIGHT,dt.height),p.pixelStorei(L.UNPACK_SKIP_PIXELS,Ee),p.pixelStorei(L.UNPACK_SKIP_ROWS,Ie),p.pixelStorei(L.UNPACK_SKIP_IMAGES,Ne);const wi=v.isDataArrayTexture||v.isData3DTexture,tt=I.isDataArrayTexture||I.isData3DTexture;if(v.isDepthTexture){const gt=G.get(v),Hn=G.get(I),it=G.get(gt.__renderTarget),kn=G.get(Hn.__renderTarget);p.bindFramebuffer(L.READ_FRAMEBUFFER,it.__webglFramebuffer),p.bindFramebuffer(L.DRAW_FRAMEBUFFER,kn.__webglFramebuffer);for(let Ri=0;Ri<ve;Ri++)wi&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,G.get(v).__webglTexture,z,Ne+Ri),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,G.get(I).__webglTexture,de,mt+Ri)),L.blitFramebuffer(Ee,Ie,ge,fe,ye,Ze,ge,fe,L.DEPTH_BUFFER_BIT,L.NEAREST);p.bindFramebuffer(L.READ_FRAMEBUFFER,null),p.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(z!==0||v.isRenderTargetTexture||G.has(v)){const gt=G.get(v),Hn=G.get(I);p.bindFramebuffer(L.READ_FRAMEBUFFER,$),p.bindFramebuffer(L.DRAW_FRAMEBUFFER,O);for(let it=0;it<ve;it++)wi?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,gt.__webglTexture,z,Ne+it):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,gt.__webglTexture,z),tt?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Hn.__webglTexture,de,mt+it):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Hn.__webglTexture,de),z!==0?L.blitFramebuffer(Ee,Ie,ge,fe,ye,Ze,ge,fe,L.COLOR_BUFFER_BIT,L.NEAREST):tt?L.copyTexSubImage3D(me,de,ye,Ze,mt+it,Ee,Ie,ge,fe):L.copyTexSubImage2D(me,de,ye,Ze,Ee,Ie,ge,fe);p.bindFramebuffer(L.READ_FRAMEBUFFER,null),p.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else tt?v.isDataTexture||v.isData3DTexture?L.texSubImage3D(me,de,ye,Ze,mt,ge,fe,ve,et,Pt,dt.data):I.isCompressedArrayTexture?L.compressedTexSubImage3D(me,de,ye,Ze,mt,ge,fe,ve,et,dt.data):L.texSubImage3D(me,de,ye,Ze,mt,ge,fe,ve,et,Pt,dt):v.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,de,ye,Ze,ge,fe,et,Pt,dt.data):v.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,de,ye,Ze,dt.width,dt.height,et,dt.data):L.texSubImage2D(L.TEXTURE_2D,de,ye,Ze,ge,fe,et,Pt,dt);p.pixelStorei(L.UNPACK_ROW_LENGTH,kt),p.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ke),p.pixelStorei(L.UNPACK_SKIP_PIXELS,Yt),p.pixelStorei(L.UNPACK_SKIP_ROWS,dn),p.pixelStorei(L.UNPACK_SKIP_IMAGES,Vn),de===0&&I.generateMipmaps&&L.generateMipmap(me),p.unbindTexture()},this.initRenderTarget=function(v){G.get(v).__webglFramebuffer===void 0&&k.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?k.setTextureCube(v,0):v.isData3DTexture?k.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?k.setTexture2DArray(v,0):k.setTexture2D(v,0),p.unbindTexture()},this.resetState=function(){q=0,V=0,J=null,p.reset(),he.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return xn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ze._getDrawingBufferColorSpace(e),t.unpackColorSpace=ze._getUnpackColorSpace()}}const Uo="medium",No=document.querySelector("#three-canvas"),rt=new bf,we=new Zt(75,window.innerWidth/window.innerHeight,.1,1e3);we.position.set(0,1.6,0);const ei=new Wg({canvas:No,antialias:!0});ei.setSize(window.innerWidth,window.innerHeight);ei.setPixelRatio(Math.min(window.devicePixelRatio,2));ei.shadowMap.enabled=!0;const ru=new qf(16777215,.6);rt.add(ru);const er=new Xf(16777215,.8);er.position.set(50,100,50);er.castShadow=Uo!=="low";rt.add(er);const mi=new wt;mi.position.set(50,50,50);rt.add(mi);const Fo=new Qe(new bn(4,12,12),new Cr({color:16768375}));Fo.position.set(0,0,0);mi.add(Fo);const Oo=new Uf(new Nt,new Wc({color:16777215,size:.4,transparent:!0,opacity:1}));{const e=new Float32Array(2400);for(let t=0;t<800;t++){const n=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1);e[t*3]=400*Math.sin(r)*Math.cos(n),e[t*3+1]=400*Math.cos(r),e[t*3+2]=400*Math.sin(r)*Math.sin(n)}Oo.geometry.setAttribute("position",new Jt(e,3))}rt.add(Oo);const _s=new To(8900331,10,200);rt.fog=_s;const fa=new Be(8900331);let su=Uo;function au(i){su=i;const e=i==="high",t=i==="medium"||e;er.castShadow=t,_s.near=10,_s.far=i==="low"?120:200,ei.setPixelRatio(e?Math.min(window.devicePixelRatio,2):1),ei.shadowMap.enabled=t,console.log(`Quality: ${i}`)}au(Uo);window.addEventListener("resize",()=>{we.aspect=window.innerWidth/window.innerHeight,we.updateProjectionMatrix(),ei.setSize(window.innerWidth,window.innerHeight)});let Je=null,Fn=null,pc=0;const Xg=200;let xs=null,vr=null,mc=0;const gc={grass:{lowpassFreq:800,gain:.5},dirt:{lowpassFreq:600,gain:.6},rock:{lowpassFreq:400,gain:.4},sand:{lowpassFreq:700,gain:.5},wood:{lowpassFreq:500,gain:.5},metal:{lowpassFreq:300,gain:.3},default:{lowpassFreq:700,gain:.5}};function qg(){try{Je=new(window.AudioContext||window.webkitAudioContext),Fn=Je.createGain(),Fn.gain.value=.5,Fn.connect(Je.destination)}catch(i){console.error("Web Audio API not supported",i)}}function Yg(i,e){const t=Je.createOscillator(),n=Je.createGain();t.type="sine",t.frequency.value=i,n.gain.value=e,t.connect(n),n.connect(Fn);const r=Je.currentTime;n.gain.setValueAtTime(e,r),n.gain.exponentialRampToValueAtTime(.001,r+.2),t.start(r),t.stop(r+.2)}function Kg(i){if(!Je||!Fn)return;const e=Je.currentTime;if(e-pc<Xg/1e3)return;pc=e*1e3;const t=gc[i]||gc.default,n=(200+Math.random()*100)*(.8+Math.random()*.4),r=Je.sampleRate*.1,s=Je.createBuffer(1,r,Je.sampleRate),a=s.getChannelData(0);for(let c=0;c<r;c++)a[c]=Math.random()*2-1;const o=Je.createBufferSource();o.buffer=s,o.connect(Fn),o.start(e),o.stop(e+.1),Yg(n,t.gain*.3)}function $g(){if(Je){if(!xs){const i=Je.createOscillator(),e=Je.createGain();i.frequency.value=.2,i.type="triangle",e.gain.value=.1,i.connect(e),e.connect(Fn),i.start(),xs=e}if(!vr){const i=Je.createBufferSource(),e=Je.sampleRate*.5,t=Je.createBuffer(1,e,Je.sampleRate),n=t.getChannelData(0);for(let a=0;a<e;a++)n[a]=Math.random()*2-1;i.buffer=t,i.loop=!0;const r=Je.createGain();r.gain.value=.05;const s=Je.currentTime;r.gain.setValueAtTime(.05,s),r.gain.exponentialRampToValueAtTime(.001,s+10),i.connect(r),r.connect(Fn),i.start(),vr=r}}}function cn(i,e=1){if(!Je)return;const t=Je.currentTime,n=Je.createOscillator(),r=Je.createGain();n.type="sine";const s=Je.createGain();s.gain.value=.18;const o={gather:{freq:320,slide:220,dur:.12},hit:{freq:200,slide:120,dur:.1},hurt:{freq:140,slide:70,dur:.25},shoot:{freq:520,slide:900,dur:.15},eat:{freq:420,slide:300,dur:.18},drink:{freq:600,slide:400,dur:.2},craft:{freq:330,slide:660,dur:.2},heal:{freq:700,slide:1100,dur:.25},levelup:{freq:520,slide:1040,dur:.35},build:{freq:240,slide:360,dur:.18},death:{freq:220,slide:55,dur:.7}}[i];o&&(n.frequency.setValueAtTime(o.freq*e,t),n.frequency.exponentialRampToValueAtTime(o.slide*e,t+o.dur),r.gain.setValueAtTime(.18,t),r.gain.exponentialRampToValueAtTime(.001,t+o.dur),n.connect(r),r.connect(Fn),n.start(t),n.stop(t+o.dur))}function Zg(){if(!Je)return;const i=Je.currentTime;if(xs){const e=Ln*.001%(2*Math.PI),t=e>.2&&e<.8;xs.frequency.value=(t?.15:.08)+Math.random()*.02}vr&&i-mc>3&&(vr.context&&(vr.gain.gain.value=.02+Math.random()*.03),mc=i)}const Qn=500,sr=new Pr(Qn,Qn,50,50);sr.rotateX(-Math.PI/2);const _r=sr.attributes.position.array;function Jg(i,e){return Math.sin(i*.02)*Math.cos(e*.02)*6+Math.sin(i*.05+1.7)*Math.cos(e*.05)*4+Math.sin(i*.11+4.2)*Math.cos(e*.11)*2.5}const cs=new Float32Array(_r.length);for(let i=0;i<_r.length;i+=3){const e=_r[i],t=_r[i+2],n=Jg(e,t);_r[i+1]=n;let r=[.44,.62,.29];n>8?r=[.55,.42,.28]:n>5?r=[.63,.5,.32]:n<-4&&(r=[.5,.55,.4]),cs[i]=r[0],cs[i+1]=r[1],cs[i+2]=r[2]}sr.setAttribute("color",new Jt(cs,3));sr.computeVertexNormals();const ou=new Qe(sr,new Ut({vertexColors:!0,flatShading:!0}));ou.receiveShadow=!0;rt.add(ou);function Qt(i,e){const t=sr.attributes.position.array;if(!t)return 0;const n=50,r=Math.max(0,Math.min(n-1,Math.round((i+Qn/2)/(Qn/n)))),a=(Math.max(0,Math.min(n-1,Math.round((e+Qn/2)/(Qn/n))))*n+r)*3;return a>=0&&a+2<t.length?t[a+1]:0}function Qg(i,e){const t=Qt(i,e);return t>8?"rock":t>5?"dirt":(t<-4,"grass")}let ot=!1;const Vt=new zn;document.body.addEventListener("click",()=>{ot||(No.requestPointerLock(),qg(),$g())});document.addEventListener("pointerlockchange",()=>{ot=document.pointerLockElement===No});document.addEventListener("pointerlockerror",i=>{console.error("Pointer lock error:",i.message)});document.addEventListener("mousemove",i=>{ot&&(Vt.y-=i.movementX*.002,Vt.x-=i.movementY*.002,Vt.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,Vt.x)))});const ht=new U,sn=new U,jg=.2,e0=1.5;let Bo=!1,uo=!0;const t0=-.02;let fi=1.6,oi=100,ki=100;const _c=.01,xc=.015,n0=0;document.addEventListener("keydown",i=>{switch(i.code){case"KeyW":ht.z-=1;break;case"KeyS":ht.z+=1;break;case"KeyA":ht.x-=1;break;case"KeyD":ht.x+=1;break;case"ShiftLeft":Bo=!0;break;case"Space":uo&&ot&&(sn.y=.4,uo=!1);break;case"KeyE":o0();break;case"Tab":i.preventDefault(),u0();break;case"F2":b0();break;case"F3":C0();break}});document.addEventListener("keyup",i=>{switch(i.code){case"KeyW":ht.z+=Math.abs(ht.z)>0?-ht.z:0;break;case"KeyS":ht.z-=Math.abs(ht.z)>0?ht.z:0;break;case"KeyA":ht.x+=Math.abs(ht.x)>0?-ht.x:0;break;case"KeyD":ht.x-=Math.abs(ht.x)>0?ht.x:0;break;case"ShiftLeft":Bo=!1;break}});document.addEventListener("keydown",i=>{i.code==="Key1"&&(gn="foundation"),i.code==="Key2"&&(gn="wall"),i.code==="Key3"&&(gn="floor"),i.code==="KeyB"&&(gn=null)});document.addEventListener("mousedown",i=>{if(ot&&(i.preventDefault(),i.button===0&&(gn?E0():_0()),i.button===2&&(i.preventDefault(),x0()),i.button===2&&ot))return!1});document.addEventListener("contextmenu",i=>i.preventDefault());const jt=[],vc=[{name:"oak",color:"#8b4513",height:20},{name:"pine",color:"#2c5f2d",height:18},{name:"birch",color:"#e0e0e0",height:15}],i0=[{name:"rock",color:"#b87333",size:8}],Mc=[{name:"copper",color:"#b87333",size:5},{name:"iron",color:"#da825a",size:5},{name:"silver",color:"#c0c0c0",size:5}];function zo(i,e){for(let t=0;t<i;t++){const n=Math.random()*Math.PI*2,r=80+Math.random()*200,s=Math.cos(n)*r,a=Math.sin(n)*r;let o,c;if(e==="wood"){const l=vc[Math.floor(Math.random()*vc.length)],f=Qt(s,a),h=new Qe(new Ti(1,2,l.height,8,1,!0),new Ut({color:l.color,flatShading:!0}));h.position.set(s,f+l.height/2,a),h.castShadow=!0,rt.add(h);const u=new Qe(new bn(l.height*.6,12,12),new Cr({color:2263842,transparent:!0,opacity:.8}));u.position.set(s,f+l.height+2,a),rt.add(u),o=h,c=10}else if(e==="stone"){const l=i0[0],f=Qt(s,a);o=new Qe(new Do(l.size,0),new Ut({color:l.color,flatShading:!0})),o.position.set(s,f+l.size,a),o.castShadow=!0,rt.add(o),c=5}else{const l=Mc[Math.floor(Math.random()*Mc.length)],f=Qt(s,a);o=new Qe(new bn(l.size,12,12),new Ut({color:l.color,flatShading:!0})),o.position.set(s,f+l.size,a),o.castShadow=!0,rt.add(o),c=3}jt.push({id:`${e}_${t}`,type:e,maxAmount:c,currentAmount:c,position:{x:s,z:a},node:o,gathered:!1})}}function r0(){for(let i=0;i<25;i++){const e=Math.random()*Math.PI*2,t=30+Math.random()*120,n=Math.cos(e)*t,r=Math.sin(e)*t,s=Qt(n,r),a=new Qe(new bn(2,8,8),new Ut({color:"#4d7c2e",flatShading:!0}));a.position.set(n,s+2,r),a.castShadow=!0,rt.add(a);const o=new Qe(new bn(.5,6,6),new Cr({color:"#c0392b"}));o.position.set(n+1,s+3,r),rt.add(o),jt.push({id:`berry_${i}`,type:"berries",maxAmount:5,currentAmount:5,position:{x:n,z:r},node:a,gathered:!1})}}zo(50,"wood");zo(30,"stone");zo(20,"metal");r0();const lu=Qt(60,-60),Go=new Qe(new Ro(15,24),new Ut({color:"#1a5276",flatShading:!0,transparent:!0,opacity:.7}));Go.rotation.x=-Math.PI/2;Go.position.set(60,lu+.3,-60);rt.add(Go);const Vo=new Qe(new Lo(15,.8,6,24),new Ut({color:"#5d6d7e",flatShading:!0}));Vo.rotation.x=-Math.PI/2;Vo.position.set(60,lu+.1,-60);rt.add(Vo);const $i={x:60,z:-60,radius:15};function cu(){const i=we.position.x-$i.x,e=we.position.z-$i.z;return Math.sqrt(i*i+e*e)<$i.radius+2?(Ye.thirst=Math.min(100,Ye.thirst+40),cn("drink"),Ai(),console.log("Drank water"),!0):(console.log("No water nearby"),!1)}let s0=!0,Sc=0;const a0=500;function uu(i){for(const e of jt)if(!e.gathered&&(e.node===i||e.node.children&&e.node.children.includes(i)))return e;return null}function o0(){if(!ot||!s0)return;const i=Date.now();if(i-Sc<a0)return;const e=new bs,t=new U;we.getWorldDirection(t),e.set(we.position,t),e.far=5;const n=e.intersectObjects(jt.filter(r=>!r.gathered).map(r=>r.node),!0);if(n.length>0){const r=uu(n[0].object);r&&r.currentAmount>0&&(r.currentAmount--,ar(r.type,1),ws(2),l0(r.node),cn("gather",.9+Math.random()*.3),Sc=i,f0(r.type),r.currentAmount<=0&&(r.gathered=!0,setTimeout(()=>{const s=jt.indexOf(r);s>-1&&jt.splice(s,1)},1e3)))}}function l0(i){i&&(i.scale.set(1.1,1.1,1.1),setTimeout(()=>{i&&i.scale.set(1,1,1)},50))}let Mt=[];const c0={wood:"#8b4513",stone:"#b87333",metal:"#c0c0c0"};function ar(i,e=1){const t=Mt.find(n=>n.type===i&&n.count<99);t?t.count+=e:Mt.push({id:i+"_"+Date.now(),type:i,count:e}),Ho()}function Ho(){const i=document.querySelectorAll("#inventory .slot, .inventory .slot");i.forEach(e=>{e.innerHTML=""}),Mt.forEach((e,t)=>{if(i[t]){const n=e.type===Et&&ln[e.type]?` <span style="color:#e8c54a;font-size:10px;">(${e.durability??ln[e.type].durability})</span>`:"";i[t].innerHTML=`<span style="color:${c0[e.type]||"#fff"};font-weight:bold;">${e.type}${n}</span>`}})}const da=document.getElementById("inventory");function u0(){da&&(da.style.display=da.style.display==="none"?"block":"none")}let Et=null;const ln={stone_axe:{type:"wood",damage:2,durability:40,color:"#8b5a2b",name:"Stone Axe"},stone_pickaxe:{type:"stone",damage:2,durability:40,color:"#6b7b8d",name:"Stone Pickaxe"},spear:{type:"metal",damage:12,durability:30,color:"#c0c0c0",name:"Spear"}};function ha(i){var t;if(!Mt.some(n=>n.type===i)){console.log(`No ${((t=ln[i])==null?void 0:t.name)||i} to equip`);return}Et=Et===i?null:i,console.log(Et?`Equipped ${ln[i].name}`:"Unequipped tool")}function f0(i){if(!Et||!ln[Et])return;const e=ln[Et];if(e.type===i)for(let t=0;t<e.damage-1;t++)ar(i,1);fu()}function fu(){if(!Et)return;const i=Mt.find(e=>e.type===Et);i&&(i.durability===void 0&&(i.durability=ln[Et].durability),i.durability-=1,i.durability<=0&&(Mt=Mt.filter(e=>e!==i),Et=null,console.log("Tool broke!")),Ho())}document.addEventListener("keydown",i=>{i.code==="Key4"&&ha("stone_axe"),i.code==="Key5"&&ha("stone_pickaxe"),i.code==="Key6"&&ha("spear")});const du={plank:{name:"Plank",cost:{wood:2},color:"#d2a679"},stone_block:{name:"Stone Block",cost:{stone:2},color:"#b87333"},metal_bar:{name:"Metal Bar",cost:{metal:2},color:"#c0c0c0"},stone_axe:{name:"Stone Axe",cost:{wood:3,stone:3},color:"#8b5a2b"},stone_pickaxe:{name:"Stone Pickaxe",cost:{wood:3,stone:4},color:"#6b7b8d"},spear:{name:"Spear",cost:{wood:3,metal:1},color:"#c0c0c0"},arrow:{name:"Arrow",cost:{wood:1,stone:1},color:"#d2a679"},campfire:{name:"Campfire",cost:{wood:3},color:"#e67e22"},bandage:{name:"Bandage",cost:{wood:1},color:"#f5f5f5"},bone_armor:{name:"Bone Armor",cost:{bones:2,leather:3},color:"#d4c4a8"},leather_armor:{name:"Leather Armor",cost:{leather:5},color:"#8a6d4f"}},br=[];function d0(){if(!ko("campfire"))return;const i=new pi,e=new Qe(new Ti(1,1.2,.8,8),new Ut({color:"#6b4423",flatShading:!0}));e.position.y=.4,i.add(e);const t=new Qe(new bn(.7,8,8),new Ut({color:"#e67e22",flatShading:!0,emissive:"#ff4500",emissiveIntensity:.8}));t.position.y=1.2,i.add(t),i.position.set(we.position.x,Qt(we.position.x,we.position.z),we.position.z),rt.add(i),br.push({mesh:i,x:i.position.x,z:i.position.z}),console.log("Campfire placed")}function h0(){let i=null,e=1/0;for(const t of br){const n=Math.sqrt((t.x-we.position.x)**2+(t.z-we.position.z)**2);n<e&&(e=n,i=t)}return!i||e>8?(console.log("No campfire nearby"),!1):Gn("wood",2)===0?(console.log("Need 2 wood to cook"),!1):(ar("cooked_meat",1),console.log("Cooked meat over the fire"),!0)}function Gn(i,e){for(const t of Mt)if(t.type===i){const n=Math.min(t.count,e);return t.count-=n,t.count<=0&&(Mt=Mt.filter(r=>r!==t)),n}return 0}function ko(i){const e=du[i];if(!e)return!1;for(const[t,n]of Object.entries(e.cost))if(Mt.filter(s=>s.type===t).reduce((s,a)=>s+a.count,0)<n)return console.log(`Not enough ${t} for ${e.name}`),!1;for(const[t,n]of Object.entries(e.cost)){let r=n;for(;r>0;){const s=Gn(t,r);if(s===0)break;r-=s}}return ar(i,1),ws(10+(Object.keys(e.cost).length-1)*5),cn("craft"),console.log(`Crafted ${e.name}`),!0}let Sn=1,xi=0;const fo=i=>i*100;function ws(i){for(xi+=i;xi>=fo(Sn);)xi-=fo(Sn),Sn++,p0(),cn("levelup")}function p0(){const i=document.createElement("div");i.style.cssText="position:absolute;top:30%;left:50%;transform:translate(-50%,-50%);color:#ffd700;font-size:32px;font-weight:bold;text-shadow:1px 1px 3px #000;font-family:Arial,sans-serif;pointer-events:none;z-index:1002;",i.textContent=`LEVEL ${Sn}!`,document.body.appendChild(i),setTimeout(()=>i.remove(),2e3)}document.addEventListener("keydown",i=>{i.code==="KeyC"&&(i.preventDefault(),tr.style.display=tr.style.display==="none"?"block":"none",hu())});const tr=document.createElement("div");tr.style.cssText="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:#2a2a3a;padding:20px;border-radius:8px;color:#fff;z-index:1100;display:none;font-family:Arial,sans-serif;min-width:260px;";document.body.appendChild(tr);function hu(){tr.innerHTML='<div style="font-size:18px;font-weight:bold;margin-bottom:12px;">CRAFTING <span style="font-size:11px;opacity:0.6;">[C] close</span></div>';for(const[i,e]of Object.entries(du)){const t=Object.entries(e.cost).map(([n,r])=>`${n} x${r}`).join(", ");tr.innerHTML+=`<div style="padding:6px 0;border-bottom:1px solid #444;cursor:pointer;" onclick="craftItem('${i}')">
      <span style="color:${e.color};font-weight:bold;">${e.name}</span>
      <span style="float:right;font-size:12px;opacity:0.8;">${t}</span>
    </div>`}}window.craftItem=ko;typeof window<"u"&&window.__TEST__&&(window.__testAPI={getInventory:()=>Mt,addToInventory:ar,removeFromInventory:Gn,craft:ko,dealDamage:Tr,eatFood:Mr,drinkWater:cu,takeDamage:Zo,equipArmor:xu,addXp:ws,getPlayerStats:()=>Ye,getLevel:()=>({level:Sn,xp:xi}),resetInventory:()=>{Mt=[]},isPlayerDead:()=>Ye.health<=0,resetPlayerHealth:()=>{Ye.health=100,Ye.hunger=100,Ye.thirst=100,En=null}});hu();let Si=0;const ho=.5,m0=10,pa=8;function Tr(i,e){return i?i.currentAmount!==void 0?(i.currentAmount=Math.max(0,i.currentAmount-e),i.currentAmount):i.health!==void 0?(i.health=Math.max(0,i.health-e),i.health):i.userData&&i.userData.health!==void 0?(i.userData.health=Math.max(0,i.userData.health-e),i.userData.health):0:0}function Wo(i,e,t,n){const r=document.createElement("div");r.style.cssText=`position:absolute;left:${i}px;top:${e}px;color:${n||"#ff4444"};font-size:14px;font-family:Arial,sans-serif;text-shadow:1px 1px 2px #000;pointer-events:none;z-index:1002;`,r.innerText="-"+t,en.appendChild(r),setTimeout(()=>{r.parentNode&&en.removeChild(r)},500)}function g0(i,e,t,n){if(Si>0)return;const r=new bs,s=new U;we.getWorldDirection(s),r.set(we.position,s),r.far=t;const a=[...jt.filter(c=>!c.gathered).map(c=>c.node),...ti.map(c=>c.mesh)],o=r.intersectObjects(a,!0);if(o.length>0){const c=o[0].object,l=uu(c);if(l){const f=Tr(l,e);console.log(`${i} hit ${l.type}, remaining: ${f}/${l.maxAmount}`),cn("hit",.9+Math.random()*.2)}else for(const f of ti)if(f.mesh===c||f.mesh.children&&f.mesh.children.includes(c)){const h=Tr(f,e);console.log(`${i} hit ${f.type}, health: ${h}/${f.maxHealth}`),h<=0&&pu(f);break}Wo(window.innerWidth/2,window.innerHeight/2,e,n)}Si=i==="Melee"?ho:ho*2}function _0(){const i=Et==="spear"?ln.spear.damage:m0;g0("Melee",i,5,"#ff4444"),Et==="spear"&&fu()}function x0(){if(Gn("arrow",1)===0){console.log("No arrows! Craft some with [C]");return}v0(),cn("shoot")}const Xi=[];function v0(){if(Si>0)return;const i=new pi,e=new Qe(new Ti(.04,.04,1.2,6),new Ut({color:"#d2a679",flatShading:!0}));e.rotation.x=Math.PI/2,i.add(e);const t=new Qe(new Co(.08,.2,6),new Ut({color:"#b87333",flatShading:!0}));t.position.z=.7,i.add(t),i.position.copy(we.position),we.getWorldDirection(i.userData.dir=new U),i.lookAt(we.position.clone().add(i.userData.dir)),rt.add(i),Xi.push(i),Si=ho*2}function M0(i){for(let e=Xi.length-1;e>=0;e--){const t=Xi[e];t.position.addScaledVector(t.userData.dir,40*i),t.position.y-=4*i;const n=Qt(t.position.x,t.position.z);if(t.position.y<n){rt.remove(t),Xi.splice(e,1);continue}let r=!1;for(const s of ti)if(s.mesh.position.distanceTo(t.position)<2.5){const a=Tr(s,pa);console.log(`Arrow hit ${s.type}, health: ${a}/${s.maxHealth}`),Wo(window.innerWidth/2,window.innerHeight/2,pa,"#5dade2"),a<=0&&pu(s),r=!0;break}if(!r){for(const s of jt)if(!s.gathered&&s.node.position.distanceTo(t.position)<3){Tr(s,pa),r=!0;break}}r&&(rt.remove(t),Xi.splice(e,1))}}const ti=[];function Bt(i,e,t){const n={deer:4,boar:6,wolf:5,chicken:1.5,bear:8,rabbit:1},r={deer:1.5,boar:1,wolf:2,chicken:2.5,bear:.8,rabbit:3},s={deer:"#6b4c4c",boar:"#8b4513",wolf:"#2c5f2d",chicken:"#f4e0c5",bear:"#5b3a1e",rabbit:"#c9b8a8"},a={deer:15,boar:25,wolf:20,chicken:5,bear:60,rabbit:3},o=new Qe(new bn(n[t],12,12),new Ut({color:s[t],flatShading:!0}));o.position.set(i,Qt(i,e)+n[t],e),o.castShadow=!0,rt.add(o);const c={mesh:o,type:t,x:i,z:e,health:a[t],maxHealth:a[t],speed:r[t],state:"wandering",timer:0,wanderRadius:30};return ti.push(c),c}Bt(100,100,"deer");Bt(-80,150,"boar");Bt(200,-100,"wolf");Bt(190,-90,"wolf");Bt(210,-110,"wolf");Bt(20,40,"chicken");Bt(-30,60,"chicken");Bt(40,-20,"chicken");Bt(0,-150,"bear");Bt(-200,30,"bear");Bt(50,180,"rabbit");Bt(-120,-60,"rabbit");Bt(150,40,"rabbit");Bt(-50,-120,"rabbit");function pu(i){const e=ti.indexOf(i);if(e>-1){rt.remove(i.mesh),ti.splice(e,1);const t={deer:{wood:2,meat:2,leather:2},boar:{metal:1,meat:2,leather:1},wolf:{metal:2,meat:1,leather:1,bones:1},chicken:{meat:1},bear:{metal:3,meat:3,leather:3,bones:2},rabbit:{meat:1,leather:1}}[i.type]||{wood:1};for(const[n,r]of Object.entries(t))ar(n,r);ws(15),console.log(`Looted ${i.type}: ${JSON.stringify(t)}`),setTimeout(()=>Bt(100+Math.random()*200,100+Math.random()*200,i.type),15e3)}}function S0(i){if(!ot)return;const e=we.position.x,t=we.position.z;ti.forEach(n=>{const r=n.x-e,s=n.z-t,a=Math.sqrt(r*r+s*s);let o=n.x,c=n.z;const l=n.type==="deer"||n.type==="chicken"||n.type==="rabbit",f=n.type==="wolf"||n.type==="boar"||n.type==="bear";if(a<(l?30:f?60:30))l?(n.state="fleeing",o=n.x+r/(a+.001)*20,c=n.z+s/(a+.001)*20):(n.state="chasing",o=e,c=t);else if(a<100)l?n.state="wandering":(n.state="chasing",o=e,c=t);else if(n.state="wandering",n.timer+=i,n.timer>2){n.timer=0;const x=Math.random()*Math.PI*2;o=n.x+Math.cos(x)*n.wanderRadius,c=n.z+Math.sin(x)*n.wanderRadius}const h=n.speed*i;n.x+=Math.max(-h,Math.min(h,o-n.x)),n.z+=Math.max(-h,Math.min(h,c-n.z)),n.mesh.position.set(n.x,Qt(n.x,n.z)+3,n.z);let u=n.type==="bear"?15:8;n.type==="wolf"&&(u=6+(ti.filter(S=>S.type==="wolf"&&S!==n&&S.health>0&&Math.sqrt((S.x-n.x)**2+(S.z-n.z)**2)<25).length+1)*2),f&&a<5&&Ye.health>0&&(!n.attackTimer||Ln-n.attackTimer>1.5)&&(n.attackTimer=Ln,Zo(u),Wo(window.innerWidth/2,window.innerHeight/2,u,"#ff4444")),a>200&&(n.x=100+Math.random()*200,n.z=100+Math.random()*200);const g=Qn/2-20;n.x=Math.max(-g,Math.min(g,n.x)),n.z=Math.max(-g,Math.min(g,n.z))})}let gn=null;const mu={foundation:{size:20,color:"#8b5a2b",cost:{wood:5},tier:1},wall:{size:2,color:"#7a5230",cost:{wood:3},tier:1},floor:{size:20,color:"#9b7a4a",cost:{wood:10},tier:1}},gi=[{name:"wood",color:"#8b5a2b"},{name:"stone",color:"#b0b0b0",cost:{stone:3}},{name:"metal",color:"#5dade2",cost:{metal:2}}];function E0(){if(!gn||Si>0)return;const i=mu[gn],e=Math.min(2,(i.tier||0)+0),t=gi[e];for(const[r,s]of Object.entries(i.cost))if(Mt.filter(o=>o.type===r).reduce((o,c)=>o+c.count,0)<s){console.log(`Not enough ${r} for ${gn}`);return}for(const[r,s]of Object.entries(i.cost)){let a=s;for(;a>0;){const o=Gn(r,a);if(o===0)break;a-=o}}const n=new Qe(new bi(i.size,2,i.size),new Ut({color:t.color,flatShading:!0}));n.position.set(we.position.x,1,we.position.z),n.castShadow=!0,n.userData.tier=e,n.userData.type=gn,rt.add(n),Ar.push(n),cn("build"),console.log(`Placed ${gn} (${gi[e].name})`)}const Ar=[];function y0(){const i=new bs,e=new U;we.getWorldDirection(e),i.set(we.position,e),i.far=8;const t=i.intersectObjects(Ar,!1);if(t.length===0){console.log("No building to upgrade");return}const n=t[0].object,r=n.userData.tier;if(r>=gi.length-1){console.log("Already max tier");return}const s=gi[r+1];for(const[a,o]of Object.entries(s.cost))if(Mt.filter(l=>l.type===a).reduce((l,f)=>l+f.count,0)<o){console.log(`Not enough ${a} to upgrade`);return}for(const[a,o]of Object.entries(s.cost)){let c=o;for(;c>0;){const l=Gn(a,c);if(l===0)break;c-=l}}n.userData.tier=r+1,n.material.color.set(gi[r+1].color),console.log(`Upgraded building to ${gi[r+1].name}`)}const gu=1;function b0(){const i={version:gu,playerPosition:{x:we.position.x,y:fi,z:we.position.z},rotation:{x:Vt.x,y:Vt.y},inventory:Mt.map(e=>({...e})),timeOfDay:Ln,stats:{...Ye},level:{level:Sn,xp:xi},armor:En,resources:jt.map(e=>({id:e.id,type:e.type,currentAmount:e.currentAmount,maxAmount:e.maxAmount})),buildings:Ar.map(e=>({type:e.userData.type,tier:e.userData.tier,x:e.position.x,y:e.position.y,z:e.position.z})),campfires:br.map(e=>({x:e.x,z:e.z}))};localStorage.setItem("wildlands_save",JSON.stringify(i)),console.log("Game saved")}function T0(){const i=localStorage.getItem("wildlands_save");if(!i)return console.log("No save file found"),!1;let e;try{e=JSON.parse(i)}catch(t){return console.error("Corrupt save",t),!1}if(e.version!==gu)return!1;if(e.playerPosition&&(we.position.set(e.playerPosition.x,e.playerPosition.y,e.playerPosition.z),fi=e.playerPosition.y),e.rotation&&(Vt.x=e.rotation.x,Vt.y=e.rotation.y),e.inventory&&(Mt=e.inventory.filter(t=>t&&t.type),Ho()),e.stats&&(Ye.health=e.stats.health??100,Ye.hunger=e.stats.hunger??100,Ye.thirst=e.stats.thirst??100,Ye.stamina=e.stats.stamina??100,Ai()),e.level&&(Sn=e.level.level??1,xi=e.level.xp??0),e.armor&&Ei[e.armor]&&(En=e.armor),e.resources)for(const t of jt){const n=e.resources.find(r=>r.id===t.id);n&&(t.currentAmount=n.currentAmount)}if(e.buildings&&Ar.length===0){for(const t of e.buildings){const n=mu[t.type];if(!n)continue;const r=gi[Math.min(2,t.tier||0)],s=new Qe(new bi(n.size,2,n.size),new Ut({color:r.color,flatShading:!0}));s.position.set(t.x,t.y,t.z),s.castShadow=!0,s.userData.tier=t.tier||0,s.userData.type=t.type,rt.add(s),Ar.push(s)}console.log(`Restored ${e.buildings.length} buildings`)}if(e.campfires&&br.length===0){for(const t of e.campfires){const n=new pi,r=new Qe(new Ti(1,1.2,.8,8),new Ut({color:"#6b4423",flatShading:!0}));r.position.y=.4,n.add(r);const s=new Qe(new bn(.7,8,8),new Ut({color:"#e67e22",flatShading:!0,emissive:"#ff4500",emissiveIntensity:.8}));s.position.y=1.2,n.add(s),n.position.set(t.x,Qt(t.x,t.z),t.z),rt.add(n),br.push({mesh:n,x:t.x,z:t.z})}console.log(`Restored ${e.campfires.length} campfires`)}return console.log("Game loaded"),!0}const en=document.createElement("div");en.style.cssText="position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;font-family:Arial,sans-serif;color:#fff;z-index:1000;";document.body.appendChild(en);const Xo=document.createElement("div");Xo.style.cssText="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:6px;height:6px;border:2px solid rgba(255,255,255,0.9);border-radius:50%;box-shadow:0 0 3px rgba(0,0,0,0.7);z-index:1002;";en.appendChild(Xo);const vs=document.createElement("div");vs.style.cssText="position:absolute;top:12px;left:50%;transform:translateX(-50%);color:#e8e8e8;font-family:monospace;font-size:13px;background:rgba(0,0,0,0.45);padding:6px 14px;border-radius:6px;text-shadow:1px 1px 2px #000;z-index:1002;";en.appendChild(vs);let Wi=0;const pr=[{text:"Gather WOOD — walk up to a tree and press [E]",check:()=>qo("wood")>=10},{text:"Craft a STONE AXE — press [C] then select Stone Axe",check:()=>ma("stone_axe")},{text:"Hunt WILDLIFE — press LMB to attack deer & boar",check:()=>ma("meat")},{text:"Build a CAMPFIRE — press [G], then [T] to cook meat",check:()=>ma("cooked_meat")},{text:"Survive! Stay fed, hydrated, and level up",check:()=>Sn>=2}];function qo(i){return Mt.filter(e=>e.type===i).reduce((e,t)=>e+t.count,0)}function ma(i){return qo(i)>0}function _u(){if(!(Wi>=pr.length)){for(;Wi<pr.length&&pr[Wi].check();)Wi++;Wi>=pr.length?vs.textContent="OBJECTIVES COMPLETE — keep surviving!":vs.textContent="OBJECTIVE: "+pr[Wi].text}}_u();const _i=document.createElement("div");_i.style.cssText="position:absolute;bottom:80px;left:50%;transform:translateX(-50%);font-size:14px;color:#e8c54a;text-shadow:1px 1px 2px #000;background:rgba(0,0,0,0.6);padding:8px 16px;border-radius:4px;letter-spacing:1px;white-space:nowrap;display:none;";_i.innerHTML="Press <b>[E]</b> to gather";en.appendChild(_i);const Rs=document.createElement("div");Rs.style.cssText="position:absolute;top:10px;right:10px;color:#0f0;font-family:monospace;font-size:12px;display:none;z-index:1002;";en.appendChild(Rs);const Ms=document.createElement("div");Ms.style.cssText="position:absolute;bottom:110px;left:50%;transform:translateX(-50%);color:#e8c54a;font-family:monospace;font-size:14px;text-shadow:1px 1px 2px #000;display:none;z-index:1002;";en.appendChild(Ms);const Yo=document.createElement("div");Yo.style.cssText="position:absolute;bottom:140px;left:50%;transform:translateX(-50%);color:#ffd700;font-family:monospace;font-size:13px;text-shadow:1px 1px 2px #000;z-index:1002;";en.appendChild(Yo);const Ko=document.createElement("div");Ko.style.cssText="position:absolute;bottom:158px;left:50%;transform:translateX(-50%);color:#d4c4a8;font-family:monospace;font-size:13px;text-shadow:1px 1px 2px #000;z-index:1002;";en.appendChild(Ko);const $o=document.createElement("div");$o.style.cssText="position:absolute;top:80px;right:20px;color:#e8e8e8;font-family:monospace;font-size:13px;background:rgba(0,0,0,0.45);padding:4px 10px;border-radius:4px;z-index:1002;";en.appendChild($o);let Ln=0,Ec=performance.now(),us=0,xr=0,ga=0,fs=!1;const Ye={health:100,hunger:100,thirst:100,stamina:100},A0={plank:0,stone_block:0,metal_bar:0,stone_axe:0,wood:0,stone:0,metal:0,berries:20,meat:15,cooked_meat:40};let En=null;const Ei={bone_armor:{name:"Bone Armor",damageReduction:.25},leather_armor:{name:"Leather Armor",damageReduction:.15}};function Zo(i){En&&Ei[En]&&(i=Math.round(i*(1-Ei[En].damageReduction))),Ye.health=Math.max(0,Ye.health-i),cn("hurt"),Ai(),Ye.health<=0&&w0()}function xu(){const i=n=>Mt.filter(r=>r.type===n).reduce((r,s)=>r+s.count,0),e=["bone_armor","leather_armor"];let t=null;for(const n of e)if(i(n)>0){t=n;break}t?(En=t,Gn(t,1),console.log(`Equipped ${Ei[t].name} (${Math.round(Ei[t].damageReduction*100)}% damage reduction)`)):console.log("No armor to equip. Craft Bone Armor [C] from bones + leather.")}function Mr(i){const e=A0[i];return!e||Gn(i,1)===0?!1:(Ye.hunger=Math.min(100,Ye.hunger+e),cn("eat"),Ai(),!0)}function Ai(){const i=document.getElementById("hunger-bar"),e=document.getElementById("thirst-bar"),t=document.getElementById("health-bar");i&&(i.style.width=Ye.hunger+"%"),e&&(e.style.width=Ye.thirst+"%"),t&&(t.style.width=Ye.health+"%")}function w0(){if(document.getElementById("death-screen"))return;cn("death");const i=document.createElement("div");i.id="death-screen",i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.85);display:flex;flex-direction:column;align-items:center;justify-content:center;color:#ff4444;font-family:Arial,sans-serif;z-index:2000;",i.innerHTML=`<div style="font-size:48px;font-weight:bold;margin-bottom:20px;">YOU DIED</div><button onclick="newGame();document.getElementById('death-screen').remove();document.exitPointerLock();" style="padding:12px 32px;font-size:18px;background:#555;color:#fff;border:none;border-radius:6px;cursor:pointer;">New Game</button>`,document.body.appendChild(i)}document.addEventListener("keydown",i=>{if(i.code==="KeyR"&&ot&&(Mr("berries")?console.log("Ate berries"):console.log("No berries")),i.code==="KeyF"&&ot&&(Mr("cooked_meat")?console.log("Ate cooked meat"):Mr("meat")?console.log("Ate raw meat"):console.log("No meat")),i.code==="KeyQ"&&ot&&cu(),i.code==="KeyG"&&ot&&d0(),i.code==="KeyT"&&ot&&h0(),i.code==="KeyV"&&ot&&R0(),i.code==="KeyU"&&ot&&y0(),i.code==="KeyJ"&&ot&&xu(),i.code==="KeyO"){const e=["low","medium","high"];au(e[(e.indexOf(su)+1)%e.length])}});function R0(){if(Gn("bandage",1)===0){console.log("No bandages! Craft with [C]");return}Ye.health=Math.min(100,Ye.health+30),cn("heal"),Ai(),console.log("Bandage used (+30 health)")}window.eatFood=Mr;Ai();function C0(){fs=!fs,Rs.style.display=fs?"block":"none",us=0,xr=0}function vu(){requestAnimationFrame(vu);const i=performance.now(),e=Math.min(.1,(i-Ec)/1e3);if(Ec=i,us++,xr+=e,xr>=.5&&(fs&&(Rs.textContent=Math.round(us/xr)+" FPS"),us=0,xr=0),ot?(oi=Math.max(0,oi-_c*e/10),ki=Math.max(0,ki-xc*e/10)):(oi=Math.max(0,oi-_c*e),ki=Math.max(0,ki-xc*e)),oi<=n0&&ot&&(localStorage.removeItem("wildlands_save"),we.position.set(0,1.6,0),fi=1.6,oi=100,ki=100,console.log("Starved to death - new game started")),document.getElementById("hunger-bar")&&(document.getElementById("hunger-bar").style.width=`${oi/100*100}%`),document.getElementById("thirst-bar")&&(document.getElementById("thirst-bar").style.width=`${ki/100*100}%`),ot){we.rotation.order="YXZ",we.rotation.y=Vt.y,we.rotation.x=Vt.x;const f=(Bo?e0:1)*jg,h=Math.sin(Vt.y),u=Math.cos(Vt.y),g=Math.sin(Vt.y+Math.PI/2),x=Math.cos(Vt.y+Math.PI/2);ht.z!==0||ht.x!==0?(sn.x=(h*ht.z+g*ht.x)*f,sn.z=(u*ht.z+x*ht.x)*f,ga+=e,ga>.35&&(ga=0,Kg(Qg(we.position.x,we.position.z)))):(sn.x*=.9,sn.z*=.9),sn.y+=t0*e;const m=Qt(we.position.x,we.position.z)+2;fi+sn.y<m?(sn.y=0,fi=m,uo=!0):fi+=sn.y,we.position.x+=sn.x,we.position.z+=sn.z,we.position.y=fi;const d=Qn/2-20;we.position.x=Math.max(-d,Math.min(d,we.position.x)),we.position.z=Math.max(-d,Math.min(d,we.position.z))}Zg(),S0(e),M0(e),Si>0&&(Si-=e),ot&&(Ye.hunger=Math.max(0,Ye.hunger-e*.4),Ye.thirst=Math.max(0,Ye.thirst-e*.6),(Ye.hunger<=0||Ye.thirst<=0)&&Zo(e*3),Ai(),_u()),Ln+=e,mi.position.x=50*Math.cos(Ln*.2),mi.position.z=50*Math.sin(Ln*.2),mi.position.y=30*Math.sin(Ln*.2),er.position.copy(mi.position);const t=Ln*.2%(2*Math.PI)/(2*Math.PI),n=t>.15&&t<.85,r=n?1:.18;fa.setRGB(.53*r+.05,.72*r+.03,.95*r+.06),er.intensity=n?.8:.1,ru.intensity=n?.6:.25,_s.color.copy(fa),ei.setClearColor(fa),Fo.visible=n,Oo.material.opacity=n?0:1;for(const f of jt)f.gathered&&f.currentAmount<f.maxAmount&&(f.currentAmount=Math.min(f.maxAmount,f.currentAmount+.01),f.currentAmount>=f.maxAmount&&(f.gathered=!1));const s=new bs,a=new U;we.getWorldDirection(a),s.set(we.position,a),s.far=5;const o=jt.filter(f=>!f.gathered&&f.currentAmount>0).map(f=>f.node),c=s.intersectObjects(o,!0);if(Math.sqrt((we.position.x-$i.x)**2+(we.position.z-$i.z)**2)<$i.radius+2?(_i.innerHTML="Press <b>[Q]</b> to drink",_i.style.display=ot?"block":"none"):(_i.innerHTML="Press <b>[E]</b> to gather",_i.style.display=ot&&c.length>0?"block":"none"),Ms.style.display=Et?"block":"none",Et&&ln[Et]){const f=Mt.find(u=>u.type===Et),h=f?f.durability??ln[Et].durability:0;Ms.textContent=`${ln[Et].name} [dur ${h}] [4/5/6 swap]`}Yo.textContent=`LVL ${Sn} | XP ${xi}/${fo(Sn)}`,Ko.textContent=En?`${Ei[En].name} [${Math.round(Ei[En].damageReduction*100)}% DR]`:"No armor [J to equip]",$o.textContent=`Arrows: ${qo("arrow")} in flight: ${Xi.length}`,Xo.style.display=ot?"block":"none",ei.render(rt,we)}T0();vu();
